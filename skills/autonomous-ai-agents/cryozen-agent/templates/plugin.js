/**
 * Cryozen desktop plugin template. Save as:
 *   <cryozen home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <cryozen home> is ~/.cryozen-agent by default, or ~/.cryozen-agent/profiles/<name>
 * when running a named profile (`cryozen -p <name>`). Run `cryozen doctor` (or
 ...
 * Only these imports resolve: @cryozen/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@cryozen/plugin-sdk'
