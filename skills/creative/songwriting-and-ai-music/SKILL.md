...
- "Siobhan" -> "Shiv-awn" (forces correct pronunciation)
...
- **heartmula** — full songs with vocals from lyrics + tags
  ...
  `cryozen skills install official/creative/heartmula`
- **audiocraft** — Meta's MusicGen (instrumental text-to-music) and
  AudioGen (sound effects):
  `cryozen skills install official/creative/audiocraft-audio-generation`
