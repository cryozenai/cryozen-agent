...
Common fixes:
- Brand names: spell phonetically ("nginx" -> "engine-x", "SQL" -> "sequel")
...
QUOTES = [
    ("Every frame is a line of text,\nand every line can sing.\nThat is the whole trick.", "Example Speaker"),
]

# TTS text: flat, phonetically corrected for speech
QUOTES_TTS = [
    "Every frame is a line of text, and every line can sing. That is the whole trick.",
]
