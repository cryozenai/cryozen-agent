...
Built for [Cryozen Agent](https://github.com/cryozenai/cryozen-agent). Usable in any coding agent. Canonical source lives here; synced to [`cryozenai/cryozen-agent/skills/creative/ascii-video`](https://github.com/cryozenai/cryozen-agent/tree/main/skills/creative/ascii-video) via PR.
