 ...
 *
 * Each entry is a key/value pair that lands in the packaged Cryozen.app's
 ...
 * "Cryozen wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Cryozen wants to access Music" when Cryozen never touches the Music
