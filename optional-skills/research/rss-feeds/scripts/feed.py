...
Standard library only, so it runs in any Cryozen environment without an install
...
USER_AGENT = "cryozen-agent/1.0 (rss-feeds skill; +https://github.com/cryozenai/cryozen-agent)"
TIMEOUT = 20
NS = {
