...
Example:
    python generate_meme.py drake ~/.cryozen-agent/cache/scratch/meme.png "Writing tests" "Shipping to prod and hoping"
    python generate_meme.py "Disaster Girl" ~/.cryozen-agent/cache/scratch/meme.png "Top text" "Bottom text"
