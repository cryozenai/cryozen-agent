...
def _state_dir() -> Path:
    ...
    # Default: $CRYOZEN_HOME/watcher-state/, falling back to ~/.cryozen-agent/watcher-state/.
    cryozen_home = os.environ.get("CRYOZEN_HOME") or str(Path.home() / ".cryozen-agent")
    return Path(cryozen_home) / "watcher-state"
