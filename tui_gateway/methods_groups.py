...
_WORKER_UNAVAILABLE = "Group Chat worker is unavailable. Restart the Cryozen gateway and try again."
...
def _profile_name() -> str:
    return (os.getenv("CRYOZEN_PROFILE") or "default").strip() or "default"
