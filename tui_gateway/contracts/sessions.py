...
method("session.save", params=SessionSaveParams, result=SessionSaveResult,
       doc="Export the transcript to ~/.cryozen-agent/sessions/saved (classic /save).")
...
method("session.usage", params=SessionUsageParams, result=SessionUsageResult,
       doc="Token / context / cost counters for the session (+ provider account lines when available).")
