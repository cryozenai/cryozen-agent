"""Cryozen skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces CRYOZEN_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces CRYOZEN_HERO)
...
# Branding shared by every Cryozen-named built-in (mono/daylight override help_header).
_CRYOZEN_BRANDING: Dict[str, str] = _branding(
    "Cryozen", "✻", "Goodbye! ✻", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Cryozen - ice blue and kawaii",
        # Dark-authored ice palette.
        "colors": {
            "banner_border": "#388BFD", "banner_title": "#E0F7FF", "banner_accent": "#7DD3FC",
            "banner_dim": "#5B7A99", "banner_text": "#E0F7FF", "ui_accent": "#7DD3FC",
            "ui_label": "#60A5FA", "ui_ok": "#4caf50", "ui_error": "#ef5350", "ui_warn": "#ffa726",
            "prompt": "#E0F7FF", "input_rule": "#388BFD", "response_border": "#7DD3FC",
            "status_bar_bg": "#1a1a2e", "status_bar_text": "#C0C0C0",
            "status_bar_strong": "#7DD3FC", "status_bar_dim": "#5B7A99",
        ...
        # Light overlay (merged onto `colors`). On white the pale ice tones wash out, so the
        # light ladder keeps the hue and deepens it: ink body > label > accent > title.
        # Fills (*_bg) flip the dark navy surfaces to light polarity.
        "light_colors": {
            "banner_border": "#1F6FD1", "banner_title": "#0B5CAD", "banner_accent": "#1F7AE0",
            "banner_dim": "#5B7A99", "banner_text": "#12324F", "ui_accent": "#1F7AE0",
            "ui_label": "#1765B8", "ui_ok": "#2E7D32", "ui_error": "#C62828", "ui_warn": "#D97706",
            "prompt": "#12324F", "input_rule": "#1F6FD1", "response_border": "#1F7AE0",
            "session_label": "#1765B8", "status_bar_text": "#6F6F6F",
            "status_bar_strong": "#1F7AE0", "status_bar_dim": "#6B819A",
            "status_bar_good": "#2E7D32", "status_bar_warn": "#B45309", "status_bar_bad": "#C2410C",
            "status_bar_critical": "#B91C1C", "shell_dollar": "#1E6FC0",
            "completion_menu_bg": "#F5F5F5", "completion_menu_current_bg": "#BFDBFE",
            "selection_bg": "#D4E4F7", "status_bar_bg": "#F5F5F5", "voice_status_bg": "#F5F5F5"},
        "spinner": {},  # empty = hardcoded defaults in display.py
        "branding": _CRYOZEN_BRANDING,
        "tool_prefix": "┊"},
    "ares": {
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_CRYOZEN_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _CRYOZEN_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _routed_home_key() -> Optional[str]:
    ...
    return None if get_cryozen_home_override() is None else cryozen_home_key()
