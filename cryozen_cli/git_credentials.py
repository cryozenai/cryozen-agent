"""Non-interactive HTTPS credentials for Cryozen's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``cryozen plugins install`` with
