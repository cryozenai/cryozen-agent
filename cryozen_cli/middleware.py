"""Cryozen middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "cryozen.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "cryozen.middleware.v1"
...
def _apply_request_chain(
    ...
    from cryozen_cli.plugins import invoke_middleware
...
def apply_llm_request_middleware(request: Dict[str, Any], **context: Any) -> RequestMiddlewareResult:
    ...
    from cryozen_cli.plugins import has_middleware
...
def _run_execution_chain(kind: str, terminal_call: Callable[[Any], Any], **kwargs: Any) -> Any:
    from cryozen_cli.plugins import _delivery_manager
