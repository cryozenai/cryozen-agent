...
session from a registered ``DashboardAuthProvider`` (bundled: basic password and self-hosted OIDC; third parties
...
from cryozen_cli.dashboard_auth.registry import (
