...
dashboard SPA's design system; fonts load from the SPA's ``/fonts/``
...
<title>Sign in — Cryozen Agent</title>
<style>
  /* Brand fonts — the same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">Cryozen<span class="dot"></span>Agent</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Cryozen Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Cryozen Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://cryozenai.github.io/cryozen-agent/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
