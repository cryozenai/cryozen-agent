"""Default SOUL.md template seeded into CRYOZEN_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Cryozen Agent, built by Cryozen. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    "# Cryozen Agent Persona\n\n<!--\nThis file defines the agent's personality and tone.\n"
    "The agent will embody whatever you write here.\nEdit this to customize how Cryozen communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Cryozen Agent, an intelligent AI assistant created by Cryozen. You are helpful, "
