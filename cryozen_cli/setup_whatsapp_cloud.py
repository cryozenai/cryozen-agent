...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Cryozen to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Cryozen needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Cryozen gateway in another terminal:",
        "         cryozen gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://cryozenai.github.io/cryozen-agent/docs/user-guide/",
