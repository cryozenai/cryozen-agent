...
def _run_state_db_auto_maintenance(session_db) -> None:
    ...
    try:
        ...
        from cryozen_constants import get_cryozen_home as _get_cryozen_home  # lazy: tests patch it
        _cryozen_home_maint = _get_cryozen_home()
        ...
        for meta_key, repair, done_msg, skip_msg in (
            (
                ...
                lambda: session_db.prune_empty_ghost_sessions(sessions_dir=_cryozen_home_maint / "sessions"),
        ...
        session_db.maybe_auto_prune_and_vacuum(
            ...
            sessions_dir=_cryozen_home_maint / "sessions",
        )
