...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Cryozen Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any cryozen CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--cryozen-root",
        help="Override the Cryozen source root used by Desktop (sets CRYOZEN_DESKTOP_CRYOZEN_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets CRYOZEN_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Cryozen Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Cryozen Local Signing)",
    )
