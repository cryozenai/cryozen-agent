"""``cryozen worktree`` subcommand parser."""
...
def build_worktree_parser(subparsers) -> None:
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description="Attended reclaim for the .worktrees/ directory cryozen -w sessions "
            "accumulate. Never deletes uncommitted tracked changes, unique "
            "unpushed commits, or in-use trees; untracked-only scratch is "
            "archived to ~/.cryozen-agent/archive/worktree-prune/ before removal. See: "
            "https://cryozenai.github.io/cryozen-agent/docs/user-guide/cli#worktree-cleanup")
