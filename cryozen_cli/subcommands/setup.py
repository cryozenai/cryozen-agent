"""``cryozen setup`` subcommand parser."""
...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Cryozen Agent with an interactive wizard. "
        "Run a specific section: "
        "cryozen setup model|tts|terminal|gateway|tools|agent")
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'cryozen setup' now does this.")
    setup_parser.add_argument(
