...
from cryozen_cli.proxy.adapters.base import UpstreamAdapter
from cryozen_cli.proxy.adapters.xai import XAIGrokAdapter

# Keyed by the ``cryozen proxy start --provider <name>`` value.
ADAPTERS: Dict[str, Type[UpstreamAdapter]] = {"xai": XAIGrokAdapter}
