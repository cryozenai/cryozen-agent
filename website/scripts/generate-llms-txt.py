#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Cryozen docs site.
...
LLM reads to learn what Cryozen does.

Both publish at:
  https://cryozenai.github.io/cryozen-agent/docs/llms.txt
  https://cryozenai.github.io/cryozen-agent/docs/llms-full.txt
...
SITE_BASE = "https://cryozenai.github.io/cryozen-agent/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Cryozen as a Python Library", None),
        ("guides/use-mcp-with-cryozen", "Use MCP with Cryozen", None),
        ("guides/use-voice-mode-with-cryozen", "Use Voice Mode with Cryozen", None),
        ("guides/use-soul-with-cryozen", "Use SOUL.md with Cryozen", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Cryozen"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Cryozen Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Cryozen. A terminal-native "
        ...
        "backends. Works with OpenRouter, Anthropic, OpenAI, Google, xAI, local models, or any "
        "OpenAI-compatible endpoint."
    )
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://cryozenai.github.io/cryozen-agent/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/cryozenai/cryozen-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Cryozen Agent — Full Documentation\n",
        (
            "This file is the entire Cryozen Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Cryozen, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://cryozenai.github.io/cryozen-agent/docs\n",
        "Short index: https://cryozenai.github.io/cryozen-agent/docs/llms.txt\n",
        "\n---\n\n",
    ]
