...
//
//   <baseUrl>plugins/<name>        one page per entry in website/static/api/plugins.json
//   <baseUrl>plugins/by/<slug>     one page per maintainer (slug from extract-plugins.py)
//
