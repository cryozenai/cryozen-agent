...
Set your Tenor API key in your environment (add to `${CRYOZEN_HOME:-~/.cryozen-agent}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/cryozenai/cryozen-agent/blob/main/skills/media/gif-search/url)`
