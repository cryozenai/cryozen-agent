...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/blockchain/evm` |
...
Helper script path: `~/.cryozen-agent/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.cryozen-agent/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.cryozen-agent/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.cryozen-agent/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
