...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/blockchain/hyperliquid` |
...
The script reads `${CRYOZEN_HOME:-~/.cryozen-agent}/.env` for two optional defaults:
...
Helper script: `~/.cryozen-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.cryozen-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${CRYOZEN_HOME:-~/.cryozen-agent}/.env`.
...
```bash
python ~/.cryozen-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.cryozen-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
