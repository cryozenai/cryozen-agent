...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/blockchain/solana` |
...
Helper script path: ~/.cryozen-agent/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.cryozen-agent/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.cryozen-agent/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.cryozen-agent/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.cryozen-agent/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.cryozen-agent/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.cryozen-agent/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
