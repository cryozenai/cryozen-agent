...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/research/rss-feeds` |
...
| Related skills | [`reddit-reading`](../../optional/social-media/social-media-reddit-reading.md), [`competitor-news-monitor`](../../bundled/research/research-competitor-news-monitor.md), [`grounded-citations`](../../bundled/research/research-grounded-citations.md), [`youtube-content`](../../bundled/media/media-youtube-content.md) |
...
`python3 scripts/feed.py read https://github.com/cryozenai/cryozen-agent/releases.atom
