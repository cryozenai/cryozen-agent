...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/research/qmd` |
...
| Related skills | [`obsidian`](../../bundled/note-taking/note-taking-obsidian.md), [`cryozen-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-cryozen-agent.md), [`arxiv`](../../bundled/research/research-arxiv.md) |
...
Cryozen Agent via the native MCP client. This is the preferred
...
Then configure Cryozen Agent to connect via HTTP:
...
<dict>
  ...
  <string>/Users/YOU/.cryozen-agent/cache/scratch/qmd-daemon.log</string>
