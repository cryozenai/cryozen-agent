...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/research/gitnexus-explorer` |
...
| Related skills | [`cryozen-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-cryozen-agent.md), [`codebase-inspection`](../../bundled/software-development/software-development-codebase-inspection.md) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  cryozen-agent users don't need.
