...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/finance/stocks` |
...
```
SCRIPT=~/.cryozen-agent/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.cryozen-agent/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
