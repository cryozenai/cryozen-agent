...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Cryozen desktop transcript.
...
- A Cryozen desktop conversation for native cards; the backend may be local or remote.
...
```text
cryozen skills install official/productivity/property-listings
```
