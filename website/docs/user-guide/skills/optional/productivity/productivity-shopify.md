...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/productivity/shopify` |
...
| Related skills | [`airtable`](../../bundled/productivity/productivity-airtable.md) |
...
4. Save to `${CRYOZEN_HOME:-~/.cryozen-agent}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Cryozen","productType":"Apparel","tags":["test"]}}'
```
