...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/web-development/page-agent` |
...
- User wants **Cryozen itself to drive a browser** → use Cryozen' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
