...
| | |
|---|---|
| Source | Optional — install with `cryozen skills install official/creative/concept-diagrams` |
...
- Dedicated software / cloud infrastructure architecture with a dark tech aesthetic
