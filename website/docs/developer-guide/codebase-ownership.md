...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `cryozen_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `cryozen_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Cryozen Plugin](plugins/index.md) |
...
| Session storage | `cryozen_state.py`, `cryozen_state_*.py` | [Session Storage](session-storage.md) |
