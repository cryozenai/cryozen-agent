"""FAL.ai registration adapter. Catalog, payload, submission and Clarity Upscaler chaining live
in :mod:`tools.image_generation_tool`; this plugin imports it at call time so tests keep
patching ``image_tool.*`` and there is one FAL code path."""
