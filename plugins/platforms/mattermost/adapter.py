...
def interactive_setup() -> None:
    ...
    from cryozen_cli.cli_output import prompt, print_header, print_info, print_success
    ...
    print()
    info("📬 Home Channel: where Cryozen delivers cron job results and notifications.",
    ...
    print_info("   Open config in your editor:  cryozen config edit")
