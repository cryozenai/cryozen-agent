...
class AnthropicProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        if not api_key:
            return None
        from cryozen_cli.models import _ANTHROPIC_MODELS_MAX_PAGES, _anthropic_models_url, _anthropic_next_cursor
...
anthropic = AnthropicProfile(
    name="anthropic", aliases=("claude", "claude-code"), api_mode="anthropic_messages",
