 ...
 *   - CRYOZEN AGENT wordmark in the system face, bold, uppercase, tracked
 ...
 * 99% of users; the rest will use the CLI installer with a -CryozenHome
 * flag. Showing %LOCALAPPDATA% to grandma is developer-brain.
 */
export default function Welcome() {
  return (
    <div className="cryozen-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>CRYOZEN AGENT</span>
          </span>
          <span aria-hidden="true">CRYOZEN AGENT</span>
        </p>
