...
function seedProfile(cryozenHome: string, mockUrl: string, name: string, profileYaml: string): void {
...
test.beforeAll(async () => {
  ...
  // A Bot Mode bot: the roster shows ui_meta['cryozen-bots'].title.
  seedProfile(sandbox.cryozenHome, mock.url, 'alpha', 'ui_meta:\n  cryozen-bots:\n    title: Atlas Prime\n')
  // A renamed profile: `cryozen profile rename` writes display_name.
  seedProfile(sandbox.cryozenHome, mock.url, 'beta', 'display_name: Beacon\n')
