...
test.beforeAll(async () => {
  ...
  seedWriterProfile(fixture.sandbox.cryozenHome)
...
test('a DM addressed by the friendly name lands in that bot\'s Bot Chat', async () => {
  ...
  const home = fixture!.sandbox.cryozenHome
  ...
  // The recipient turn is a full `cryozen -p writer` CLI boot in the background; its
