...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @cryozen/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@cryozen/shared'],
              message: 'Plugins import only @cryozen/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
