 ...
 *
 * A public install can end up with `origin=git@github.com:cryozenai/cryozen-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/cryozenai/cryozen-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/cryozenai/cryozen-agent'
