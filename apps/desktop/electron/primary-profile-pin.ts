 ...
 *     it via `cryozen:profile:remember` without re-homing the primary.
 ...
 * the same CRYOZEN_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startCryozen() with the profile the primary is launching as. */
