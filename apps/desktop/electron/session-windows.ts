...
// by main.ts (`setBackgroundThrottling` driven by the merged `cryozen:active-work`
...
// (the "Cryozen idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Cryozen" wake word has NO preceding click,
