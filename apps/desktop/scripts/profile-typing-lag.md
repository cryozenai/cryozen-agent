...
cd apps/desktop
XCURSOR_SIZE=24 CRYOZEN_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=$HOME/.cryozen-agent/cache/scratch/cryozen-typing
# → ~/.cryozen-agent/cache/scratch/cryozen-typing.cpuprofile  (open in Chrome DevTools Performance)
# → ~/.cryozen-agent/cache/scratch/cryozen-typing.before.heapsnapshot
# → ~/.cryozen-agent/cache/scratch/cryozen-typing.after.heapsnapshot
```
