...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\cryozen\cryozen-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@cryozen/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@cryozen/shared/color': path.resolve(__dirname, '../shared/src/color.ts'),
      '@cryozen/shared': path.resolve(__dirname, '../shared/src'),
