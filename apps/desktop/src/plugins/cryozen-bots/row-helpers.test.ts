 ...
 *    the primary profile surfaced as @default instead of @cryozen;
 ...
 *    kanban/tool workers count too (cryozen-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @cryozen, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('cryozen')
