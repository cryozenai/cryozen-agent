...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/cryozen-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'cryozen_cli/config_defaults.py'), 'utf8')
