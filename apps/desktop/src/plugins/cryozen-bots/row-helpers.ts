...
import { atom, host, useValue } from '@cryozen/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @cryozen, never @default (#89484).
 ...
 *  (cryozen-agent#90268). Older gateways omit worker_session — always false. */
