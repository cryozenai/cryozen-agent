import { DEFAULT_REASONING_EFFORT, isReasoningEffort, type ReasoningEffort } from '@cryozen/shared'
...
/**
 * A pick the route does not send verbatim: `ultra` is a Cryozen-internal step
 ...
 *  never presents a Cryozen step as a wire level the route does not have. */
