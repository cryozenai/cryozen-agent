...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|cryozen):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.cryozenDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.cryozenDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Cryozen, and it is the surface the agent
