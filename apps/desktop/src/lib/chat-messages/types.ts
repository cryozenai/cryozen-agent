...
import { type BillingBlock, type PersistedTurn, type ToolLabel } from '@cryozen/shared'

import type { ErrorSurface } from '@/lib/error-surface'
import type { ToolResultMetadata } from '@/lib/tool-result-metadata'
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/cryozen'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @cryozen/shared BillingBlock).
