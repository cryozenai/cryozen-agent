...
export const LAYOUT_KEYS = {
  floating: 'cryozen.desktop.floatingPanes.v1',
  tree: 'cryozen.desktop.layoutTree.v2',
  preset: 'cryozen.desktop.layoutPreset.active',
  panes: 'cryozen.desktop.paneStates.v1',
  dismissed: 'cryozen.desktop.dismissedPanes.v1',
  shares: 'cryozen.desktop.paneShare.v1',
  hiddenTabs: 'cryozen.desktop.hiddenStripTabs.v1',
  placed: 'cryozen.desktop.userPlacedPanes.v1',
  flipped: 'cryozen.desktop.panesFlipped',
  collapsed: 'cryozen.desktop.collapsedTreeSides.v1'
} as const

function migrateLayoutScopes(initialMode: InterfaceMode) {
  const marker = 'cryozen.desktop.layoutModeScopes.v1'
