  ...
  it('prefers the host-visible image path', () => {
    expect(
      generatedImageFromResult({
        ...
        host_image: '/Users/me/.cryozen-agent/cache/images/cat.png',
        image: '/Users/me/.cryozen-agent/cache/images/cat.png',
        success: true
      })
    ).toBe('/Users/me/.cryozen-agent/cache/images/cat.png')
  })
