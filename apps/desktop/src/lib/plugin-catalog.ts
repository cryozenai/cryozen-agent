/**
 * The curated Cryozen plugin catalog as the Desktop sees it.
 *
 ...
 * `plugin-catalog/` directory at site build). A `cryozen://plugin/install?catalog=<name>`
...
export const CATALOG_ORIGIN = 'https://cryozenai.github.io/cryozen-agent'
