...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.cryozenMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.cryozenMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.cryozenMode = 'light'
