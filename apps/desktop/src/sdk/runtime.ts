 ...
 * plugins resolve `@cryozen/plugin-sdk` through the vite alias; RUNTIME-loaded
...
// `sdk/runtime` — so a module-scope `{ __CRYOZEN_PLUGIN_SDK__: sdk, … }` is
...
// `Object.keys(GLOBALS.__CRYOZEN_PLUGIN_SDK__)` threw
...
function pluginNamespaces() {
  return {
    __CRYOZEN_PLUGIN_SDK__: sdk,
    __CRYOZEN_REACT__: React,
    __CRYOZEN_REACT_JSX__: jsxRuntime,
    __CRYOZEN_REACT_JSX_DEV__: jsxDevRuntime
  }
}
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@cryozen/plugin-sdk': shimUrl('__CRYOZEN_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__CRYOZEN_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__CRYOZEN_REACT_JSX__'),
    react: shimUrl('__CRYOZEN_REACT__')
  }
