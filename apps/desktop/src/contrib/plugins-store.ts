 ...
 * `<cryozen home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'cryozen.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'cryozen.desktop.disabledPlugins.v1'
