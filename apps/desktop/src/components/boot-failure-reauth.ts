...
// True when the app is pointed at a remote backend (a remote URL or an SSH
// host). Any boot failure in this shape is fixable from Settings →
 ...
 * post-boot startCryozen()/ticket mint fails (liveness reset → rebuild, wake
