...
import { getGlobalModelOptions } from '@/cryozen'
...
// Curated order mirrors CANONICAL_PROVIDERS: Fireworks leads, ahead of
// OpenRouter and the rest of the key catalog.
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/cryozenai/cryozen-agent#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `cryozen model`
    ...
    >
      <div
        className={cn(
          ...
          bare
            ? ''
            : 'overflow-hidden rounded-xl border border-(--stroke-brand) bg-(--ui-chat-bubble-background) shadow-brand',
  ...
  return (
    <div className="grid gap-2">
      <div className="grid max-h-[60dvh] gap-2 overflow-y-auto p-1">
        ...
        {/* Fireworks leads the list, matching CANONICAL_PROVIDERS. */}
