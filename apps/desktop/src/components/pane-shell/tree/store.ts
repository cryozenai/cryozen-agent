...
writeKey('cryozen.desktop.layoutTree.v1', null)
...
writeKey('cryozen.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__CRYOZEN_LAYOUT_TREE__ = {
    close: closeTreePane,
