...
import { $billingBlock, clearBillingBlock, runBillingRecovery } from '@/store/billing-block'
 ...
 * disables the composer — slash commands (`/model`, `/login`) stay usable — it
 * only offers recovery: a deep link to the provider's billing page when one is
 * known. The sticky toast is the loud surface; this is the calm reminder that
 * outlives it.
 */
