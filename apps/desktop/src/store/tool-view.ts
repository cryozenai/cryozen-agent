...
const TOOL_VIEW_TECHNICAL_STORAGE_KEY = 'cryozen.desktop.toolView.technical'
const HIDE_CODE_DIFFS_STORAGE_KEY = 'cryozen.desktop.toolView.hideCodeDiffs'
const TOOL_DISCLOSURE_STORAGE_KEY = 'cryozen.desktop.toolDisclosure.v1'
