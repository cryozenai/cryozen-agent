...
import { getCryozenConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/cryozen'
...
const SNOOZE_KEY_PREFIX = 'cryozen:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getCryozenConfigRecord()
  } catch {
