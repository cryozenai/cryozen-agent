...
export const RECOVERY_ACTIONS = {
  ...
  restartCryozen: (): NotificationAction => ({
    label: translateNow('notifications.actions.restartCryozen'),
 ...
 *  (`cryozen_state_errors.classify_persistence_error`). */
...
const ERROR_SUMMARIES: ErrorSummaryRule[] = [
  ...
  },
  {
    ...
    action: () => RECOVERY_ACTIONS.restartCryozen()
  },
  {
