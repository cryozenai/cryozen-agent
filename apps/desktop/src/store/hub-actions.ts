...
// `cryozen skills install` exits non-zero when the security scan gate refuses,
...
// it. Two CLI shapes exist (`cryozen_cli/skills_hub.py::_scan_block_message`):
//   current: "Not installed: the security scan found 2 high-risk pattern(s) in
//            'org/skill' (listed above). Cryozen never installs unverified
