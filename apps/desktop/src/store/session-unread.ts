...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('cryozen.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('cryozen.desktop.unreadFinishedSessions')
