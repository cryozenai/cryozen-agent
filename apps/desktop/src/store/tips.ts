 ...
 * - It covers Cryozen too. "Off" from someone who has just closed a bubble means
...
const ENABLED_KEY = 'cryozen.desktop.tips.rotation.v1'

export const $tipsEnabled = persistentAtom(ENABLED_KEY, true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('cryozen.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('cryozen.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'cryozen.desktop.tips.next.v1',
  null,
...
export const $tipShownAt = persistentAtom<Record<string, number>>(
  'cryozen.desktop.tips.shownAt.v1',
  {},
  Codecs.json(value => {
