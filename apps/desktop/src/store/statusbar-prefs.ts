...
// v1 (`cryozen.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'cryozen.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'cryozen.desktop.statusbarHidden'
// v1 (`cryozen.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'cryozen.desktop.statusbarVisible.v2'
