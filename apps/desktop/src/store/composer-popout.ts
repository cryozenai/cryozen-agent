...
const POPOUT_STORAGE_KEY = 'cryozen.desktop.composerPopout.window.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'cryozen.desktop.composerPopout.gesturesEnabled'
const ZONES_STORAGE_KEY = 'cryozen.desktop.composerPopout.zones.v1'
const LEGACY_ENABLED_KEY = 'cryozen.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'cryozen.desktop.composerPopout.position'
