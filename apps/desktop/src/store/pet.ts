...
export interface PetInfo {
  ...
  // the Cryozen "run" activity state uses the in-place running row).
 ...
 * CRYOZEN_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'cryozen.desktop.pet-roam.v1'
