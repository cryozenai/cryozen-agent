...
function installBridge(
  openSessionWindow?: Window['cryozenDesktop']['openSessionWindow'],
  openWindow?: Window['cryozenDesktop']['openWindow'],
  openBrowserWindow?: Window['cryozenDesktop']['openBrowserWindow']
) {
