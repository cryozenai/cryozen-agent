...
function makeBlock(overrides: Partial<BillingBlock> = {}): BillingBlock {
  // Asserted rather than annotated: only the provider-agnostic fields matter here.
  return {
...
test('runBillingRecovery deep-links a provider to its billing page', () => {
...
test('runBillingRecovery does nothing when a provider has no billing page', () => {
