...
export interface ComposerAttachment {
  ...
  thumbnailUrl?: string
  path?: string
  /** Bounded source text from a Cryozen-generated large paste, sent only to the title path. */
  titlePreview?: string
...
export const SESSION_DRAFTS_STORAGE_KEY = 'cryozen:composer-drafts:v3'
 ...
 */
const DRAFT_SYNC_EVENT = 'cryozen:composer-draft-sync'
