import type { ModelOptionProvider, ModelOptionsResult } from '@cryozen/shared'
import { DEFAULT_REASONING_EFFORT } from '@cryozen/shared'
...
import { getLocalModelsStatus } from '@/cryozen'
...
import type { LocalModelLoadProgress } from '@/types/cryozen'
 ...
 * Returning `{}` is fine — the row then shows Cryozen' defaults.
 */
