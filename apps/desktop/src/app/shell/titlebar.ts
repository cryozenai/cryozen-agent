...
export interface TitlebarChromeContext {
  ...
  windowButtonPosition?: CryozenConnection['windowButtonPosition']
}
...
export function titlebarControlsPosition(
  windowButtonPosition: CryozenConnection['windowButtonPosition'] | undefined,
  isFullscreen = false
) {
...
export const TITLEBAR_CHROME_CHANGED_EVENT = 'cryozen:titlebar-chrome-changed'
