...
const originalCryozenDesktop = desktopWindow.cryozenDesktop
...
afterEach(() => {
  ...
  if (originalCryozenDesktop) {
    desktopWindow.cryozenDesktop = originalCryozenDesktop
  } else {
...
describe('WslgWindowControls', () => {
  it('routes minimize, maximize and close through the desktop bridge', () => {
    desktopWindow.cryozenDesktop = { windowControls } as unknown as Window['cryozenDesktop']
