...
import { getStatus } from '@/cryozen'
import { evaluateRuntimeReadiness, type RuntimeReadinessResult } from '@/lib/runtime-readiness'
import type { StatusResponse } from '@/types/cryozen'
...
export function useStatusSnapshot(
  ...
  useEffect(() => {
    ...
    // this window crosses (open, return from another app), so it runs once
    // per seam instead of every 60s.
