...
import { getLatestSessionMessages, type ProfileScope } from '@/cryozen'
...
interface BackgroundSyncParams {
  ...
  refreshCryozenConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshCryozenConfig])
}
