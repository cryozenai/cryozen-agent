...
const desktopWindow = window as unknown as { cryozenDesktop: unknown }
const originalBridge = desktopWindow.cryozenDesktop
...
afterEach(() => {
  ...
  desktopWindow.cryozenDesktop = originalBridge
})
