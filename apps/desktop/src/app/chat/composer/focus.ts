...
const FOCUS_EVENT = 'cryozen:composer-focus'
const INSERT_EVENT = 'cryozen:composer-insert'
const ATTACH_IMAGES_EVENT = 'cryozen:composer-attach-images'
const INSERT_REFS_EVENT = 'cryozen:composer-insert-refs'
const SUBMIT_EVENT = 'cryozen:composer-submit'
const VOICE_TOGGLE_EVENT = 'cryozen:composer-voice-toggle'
const MODEL_MENU_EVENT = 'cryozen:composer-model-menu'
