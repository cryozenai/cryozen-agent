import type { ProjectInfo, SessionInfo } from '@/cryozen'
 ...
 * repo shows its branches/worktrees even when they have no Cryozen sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: CryozenGitWorktree[]
): SidebarSessionGroup[] {
