...
import type { CryozenGitBranch } from '@/global'
...
const branchActionLabel = (branch: CryozenGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<CryozenGitBranch[]>([])
  ...
  const convert = async (branch: CryozenGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
