...
import { saveCryozenConfigRecord } from '@/cryozen'
...
export function RealProfileConsentDialog({ tabId }: RealProfileConsentDialogProps) {
  ...
  const { data: config, writeScope } = useCryozenConfigRecord()
  const setConfig = cryozenConfigCacheWriter()
  ...
  const enable = useCallback(async () => {
    ...
    try {
      ...
      await saveCryozenConfigRecord({ browser: { use_real_profile: true } }, writeScope)
