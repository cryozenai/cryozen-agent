...
describe('PreviewPane console state', () => {
  ...
  it('continues comment numbering in one conversation and resets it when the conversation changes', async () => {
    ...
    const previousDesktop = window.cryozenDesktop
    let captureCount = 0
    ...
    window.cryozenDesktop = previousDesktop
  })
...
describe('PreviewPane guest external handoff', () => {
  ...
  // reaches the OS browser only through the audited `cryozen:openExternal` IPC.
  ...
  async function renderWebview() {
    ...
    desktopWindow.cryozenDesktop = { openExternal } as unknown as Window['cryozenDesktop']
