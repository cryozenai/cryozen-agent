...
vi.mock('@/cryozen', () => ({
  saveCryozenConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setCryozenConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useCryozenConfigRecord: () => ({ data: mocks.loadedConfig, dataUpdatedAt: mocks.configUpdatedAt })
}))
