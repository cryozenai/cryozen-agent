...
import { getCryozenConfigDefaults, getCryozenConfigRecord, saveCryozenConfig } from '@/cryozen'
...
export function SettingsView({ onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getCryozenConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await saveCryozenConfig(await getCryozenConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {
