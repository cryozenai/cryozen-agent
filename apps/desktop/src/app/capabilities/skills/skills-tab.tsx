...
import type { OfficialSkillInfo, SkillInfo } from '@/types/cryozen'
...
const $skillsSortDesc = persistentAtom('cryozen.desktop.capabilities.skillsSortDesc', true, Codecs.bool)
