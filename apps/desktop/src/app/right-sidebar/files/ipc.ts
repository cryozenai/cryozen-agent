...
import type { CryozenReadDirEntry, CryozenReadDirResult } from '@/global'
...
export type ProjectTreeEntry = CryozenReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: CryozenReadDirEntry) {
...
async function filterIgnored(entries: CryozenReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<CryozenReadDirResult> {
