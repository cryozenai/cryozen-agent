...
const TAKEOVER_KEY = 'cryozen.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Cryozen can't clear via the API — the user
 *  sees exactly what runs instead of Cryozen silently deleting their creds. */
