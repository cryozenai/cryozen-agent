import type { CryozenReviewFile } from '@/global'
...
export function buildReviewFlatList(files: CryozenReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: CryozenReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
