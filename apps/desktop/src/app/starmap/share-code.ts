...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/cryozen'
...
const VERSION = 3
const PREFIX = 'HML' // "Cryozen Memory Loadout" — namespaces our codes like WoW's leading bytes.
