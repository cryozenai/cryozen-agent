import type { GatewayEvent, PersistedTurn } from '@cryozen/shared'
...
export interface GatewayEventDeps {
  ...
  refreshCryozenConfig: () => Promise<void>
...
export interface GatewayEventContext {
  ...
  /** Coalesced trailing refreshCryozenConfig (one per session.info burst). */
