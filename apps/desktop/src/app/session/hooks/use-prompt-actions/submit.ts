import type { PromptSubmitResult } from '@cryozen/shared'
import { type MutableRefObject, useCallback } from 'react'

import { PROMPT_SUBMIT_REQUEST_TIMEOUT_MS } from '@/cryozen'
    ...
    async (rawText: string, options?: SubmitTextOptions) => {
      ...
      try {
        ...
        const submitParams = (targetId: string) => ({
          ...
          // rather than at Cryozen. The gateway turns this into a per-turn hint
