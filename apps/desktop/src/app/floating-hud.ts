...
// hairline `--stroke-brand` paired with the soft `--shadow-brand` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-brand) bg-(--ui-chat-bubble-background) shadow-brand [-webkit-app-region:no-drag]'
