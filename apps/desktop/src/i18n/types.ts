...
export type Locale = 'en' | 'ja' | 'ar' | 'ru'
...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingCryozenDesktop: string
    }
    errors: {
      backgroundExited: string
      backgroundExitedDuringStartup: string
      backendStopped: string
      restartCryozen: string
      openLogs: string
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshCryozenPathTitle: string
      sshCryozenPathDesc: string
      sshCryozenPathPlaceholder: string
  ...
  commandCenter: {
    ...
    cryozenActiveSessions: (version: string, count: number) => string
    ...
    loadingUsage: string
    usageEmpty: (period: number) => string
    retry: string
    dailyTokens: string
    input: string
    output: string
  ...
  assistant: {
    thread: {
      ...
      errorOpenCryozenFolder: string
      errorOpenCryozenFolderFailed: string
