...
export const ar = defineLocale({
  sessionImport: {
    ...
    subtitle: 'انقل محادثة إلى Cryozen وتابع من حيث توقفت.',
    action: 'استيراد جلسة',
    ...
    chooseHelp: 'اختر جلسة لقراءة سجلها قبل نقلها إلى Cryozen.',
    ...
    you: 'أنت',
    snapshot: 'هذه المحادثة موجودة بالفعل في Cryozen. افتح نسختك الحالية للمتابعة.',
    copyNotice: 'ينسخ نص المحادثة دون تغيير الملفات الأصلية. لا يشمل مخرجات الأدوات أو الاستدلال.',
    importing: 'جارٍ الاستيراد…',
    open: 'فتح في Cryozen',
    continue: 'المتابعة في Cryozen',
  ...
  boot: {
    ready: 'Cryozen Desktop جاهز',
    desktopBootFailedWithMessage: message => `فشل تشغيل سطح المكتب: ${message}`,
    steps: {
      connectingGateway: 'جار الاتصال ببوابة سطح المكتب',
      loadingSettings: 'جار تحميل إعدادات Cryozen',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم Cryozen البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingCryozenDesktop: 'جار تشغيل Cryozen Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية Cryozen الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية Cryozen الخلفية أثناء بدء التشغيل.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية Cryozen أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateCryozen: 'تحديث Cryozen',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل Cryozen Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر Cryozen ردّك.',
      turnDoneTitle: 'أنهى Cryozen',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات Cryozen؟',
    ...
    vault: {
      ...
      otpHint: '«مفتاح الإعداد» الذي يعرضه الموقع عند تفعيل المصادقة الثنائية. بحفظه يولّد Cryozen الرموز بنفسه.',
      ...
      sources: {
        ...
        notInstalled: name => `غير مكتشف. ثبّت أداة سطر الأوامر ${name} وسجّل الدخول إليها؛ سيكتشفها Cryozen تلقائيًا.`,
        disabledDesc: 'مكتشف لكنه معطّل لـ Cryozen.',
        lockedDesc: 'مكتشف. سيطلب منك الوكيل فتحه عند الحاجة إلى بيانات دخول، أو افتحه الآن.',
        unlockedDesc: 'مفتوح لهذه الجلسة. يُقفل تلقائيًا بعد 30 دقيقة من الخمول أو عند إغلاق Cryozen.',
        statusLocked: 'مقفل',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها Cryozen). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون Cryozen في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح Cryozen سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان Cryozen في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    appearance: {
      title: 'المظهر',
      intro: 'خصص مظهر Cryozen Desktop.',
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح Cryozen.',
      ...
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ Cryozen التفاعل مع رسائلك.',
      tipsTitle: 'نصائح داخل التطبيق',
      tipsDesc:
        'نصائح تظهر أحيانًا من التطبيق وCryozen. تظهر كل نصيحة مرة واحدة. تُعطّل تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      tipsReset: count => `إظهار ${count} نصيحة مرة أخرى`,
      toursTitle: 'جولات إرشادية',
      toursDesc:
        'دع Cryozen يرشدك في التطبيق مع إبراز كل خطوة. تُعطّل الجولات تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله Cryozen — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق Cryozen وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج Cryozen إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف Cryozen التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع Cryozen قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل Cryozen مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث Cryozen نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول Cryozen',
      ...
      bundleOutOfSyncDesc:
        'تم تحديث وقت تشغيل Cryozen، لكن تطبيق سطح المكتب نفسه لا يزال إصدارًا قديمًا — لن تظهر ميزات الواجهة الجديدة (مثل Bot Mode) حتى يتم تحديث التطبيق. شغّل التحديث أدناه لإعادة بناء التطبيق. إذا لم يختفِ هذا التحذير، فأعد التثبيت من أحدث مثبّت لسطح المكتب.',
      bundleOutOfSyncAction: 'الحصول على المثبّت',
      bundleSwapPending: 'أعد التشغيل لإكمال التحديث',
      bundleSwapPendingDesc:
        'تم تثبيت التطبيق المحدَّث بالفعل — يكفي إعادة تشغيل Cryozen لتحميله. لن تتأثر المحادثات أو الإعدادات.',
      bundleSwapPendingAction: 'إعادة تشغيل Cryozen',
      updates: 'التحديثات',
      ...
      automaticUpdatesDesc: 'اسمح لـ Cryozen بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'تصغير النوافذ أو إغلاق النافذة الرئيسية يخفيها في علبة النظام (شريط القوائم على macOS) مع استمرار Cryozen في العمل. استخدم إنهاء Cryozen من قائمة العلبة أو Cmd+Q للخروج. معطّل افتراضيًا ويُطبّق على هذا الجهاز فقط.',
      ...
      loading: 'جار تحميل إعدادات Cryozen...',
    ...
    hudModifier: {
      ...
      permission:
        'اسمح لـ Cryozen في إعدادات النظام ← الخصوصية والأمان ← مراقبة الإدخال، ثم أعد المحاولة. لا تسجّل هذه الإيماءة ضغطات المفاتيح ولا تلتقط الشاشة.',
      unavailable:
        'تعذّر تشغيل مساعد إيماءة HUD أو توقف بشكل غير متوقع. أعد المحاولة أو أعد تشغيل Cryozen. يظل اختصار HUD الحالي يعمل داخل Cryozen.',
      missingHelper: 'مساعد إيماءة HUD غير موجود في تثبيت Cryozen هذا. حدّث Cryozen أو أعد تثبيته، ثم أعد المحاولة.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'اضغط مفتاحَي Command معًا من أي تطبيق لالتقاط النافذة الأمامية وإرفاقها بمسودة Cryozen الحالية. لا يُرسل أي شيء تلقائيًا. معطّل افتراضيًا ويُطبَّق على جهاز Mac هذا فقط. قد تتضمن النافذة محتوى حساسًا، لذا راجع المرفق قبل الإرسال.',
      ...
      inputPermission:
        'يتيح إذن مراقبة الإدخال لـ Cryozen رصد مفتاحَي Command أثناء استخدام تطبيق آخر. اسمح لـ Cryozen في إعدادات النظام ← الخصوصية والأمان ← مراقبة الإدخال، ثم عُد إلى هنا وأعد المحاولة.',
      screenPermission:
        'يتيح إذن تسجيل الشاشة لـ Cryozen التقاط نافذة التطبيق الأمامية عند استخدام هذا الاختصار. اسمح لـ Cryozen في إعدادات النظام ← الخصوصية والأمان ← تسجيل الشاشة، ثم عُد إلى هنا وأعد المحاولة. أعد تشغيل Cryozen إذا طلب macOS ذلك.',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح Cryozen.',
    ...
    gateway: {
      ...
      intro:
        'يشغّل Cryozen Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Cryozen تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      envOverrideTitle: 'متغيرات البيئة تتحكم في جلسة سطح المكتب هذه.',
      envOverrideDesc: 'أزل CRYOZEN_DESKTOP_REMOTE_URL و CRYOZEN_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
      localTitle: 'بوابة محلية',
      localDesc: 'تشغيل خلفية Cryozen خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      remoteTitle: 'بوابة بعيدة',
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية Cryozen بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      remoteUrlTitle: 'رابط البوابة البعيدة',
      remoteUrlDesc: 'الرابط الأساسي لخلفية لوحة التحكم البعيدة. يمكن استخدام بادئات مسار مثل /cryozen.',
      ...
      restartingMessage: 'سيعيد Cryozen Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · Cryozen ${version}` : ''}`,
    ...
    mcp: {
      ...
      deepLinkDescription:
        'طلب رابط إضافة خادم MCP هذا إلى Cryozen. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من Cryozen.',
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل Cryozen تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل Cryozen لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث Cryozen لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك Cryozen عند الانتهاء.',
    ...
    cryozenActiveSessions: (version, count) => `Cryozen ${version} لديه ${count} جلسة نشطة`,
    ...
    usageEmpty: period => `لا يوجد استخدام خلال ${period} يوم`,
    retry: 'إعادة المحاولة',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: {
        ...
        placeholder: '@cryozen:example.org'
      },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'ستعمل جلسات هذا الملف الشخصي على خادم Cryozen البعيد الذي تحدده، بدلاً من هذا الجهاز.',
    ...
    defaultDescription: 'يُستخدم عند فتح Cryozen وللمحادثات الجديدة. تبقى الجلسات الحالية في ملفاتها الشخصية.',
  ...
  modelAssignment: {
    saveFailed: 'لم يحفظ Cryozen تغيير النموذج هذا.',
  ...
  cron: {
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل Cryozen تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها Cryozen تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من Cryozen أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من Cryozen. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
      ...
      worktreeStaleBackend:
        'حدِّث خادم Cryozen لإنشاء أشجار العمل عبر هذا الاتصال البعيد — فهو أقدم من واجهة git worktree.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء Cryozen...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل Cryozen عن شيء...', 'اطلب من Cryozen تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ Cryozen الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من Cryozen فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث Cryozen...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل Cryozen...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من Cryozen تحديث نفسه من داخل التطبيق.',
    connectionRetry: 'تحقق من اتصالك وأعد المحاولة.',
    gitUnusable: 'لم يتمكن Cryozen من تشغيل Git على هذا الجهاز، لذا لم يتمكن من التحقق من التحديثات.',
    ...
    availableBody: 'إصدار جديد من Cryozen جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة Cryozen الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت Cryozen من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط Cryozen الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق Cryozen لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
      'يتولّى مُحدِّث Cryozen المهمة في نافذته الخاصة ويعيد فتح Cryozen تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح Cryozen بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد Cryozen الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد Cryozen فتح نفسه تلقائيا.',
    errorTitle: 'لم يكتمل التحديث',
    errorBody: 'لا داعي للقلق — لم يُفقد شيء. يمكنك إعادة المحاولة الآن.',
    blockerTitle: 'إغلاق المعاينات المحلية لتحديث Cryozen؟',
    blockerBody: 'يحتاج Cryozen إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
    foreignBlockerTitle: 'أغلق العمليات الأخرى لتحديث Cryozen',
    foreignBlockerBody:
      'لا يمكن لـ Cryozen إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.',
    mixedBlockerBody:
      'يمكن لـ Cryozen إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج Cryozen إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل Cryozen',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من Cryozen CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ Cryozen قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت Cryozen بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك Cryozen Agent',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل Cryozen التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء Cryozen...',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه Cryozen إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل Cryozen تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل Cryozen تلقائياً',
    ...
    authorizeThere: 'صرّح لـ Cryozen هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider =>
      `فتحنا ${provider} في المتصفح. صرّح لـ Cryozen هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض Cryozen أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل Cryozen...',
      askRestart: 'اطلب من Cryozen إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث Cryozen عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل Cryozen في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      blankPageBody: 'اكتب عنوانًا في الأعلى للتصفح، أو اطلب من Cryozen فتح صفحة.',
      finishedRestarting: message => `أنهى Cryozen إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على Cryozen إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال Cryozen يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
  ...
  interfaceMode: {
    title: 'وضع الواجهة',
    hint: 'يغيّر ما يظهر، وليس ما يستطيع Cryozen فعله.',
    sessionNote: 'يحدده الوضع البسيط. التغيير هنا يستمر لهذه الجلسة فقط؛ بدّل إلى المتقدم لجعله خيارك.',
    simple: {
      label: 'بسيط',
      description: 'للتحدث مع Cryozen. الشريط الجانبي والدردشة؛ بلا طرفية أو لوحات ملفات أو فروقات.'
    },
    advanced: {
      label: 'متقدم',
  ...
  prompts: {
    ...
    vaultSaveDesc: origin =>
      `وصل Cryozen إلى صفحة تسجيل الدخول في ${origin} ولا توجد بيانات دخول محفوظة لها. أدخلها هنا مرة واحدة؛ تُشفَّر على هذا الجهاز وتُملأ في الصفحة مباشرة، ولا يرى النموذج كلمة المرور أبدًا.`,
    ...
    vaultCodeDesc: site =>
      `يطلب ${site} رمزًا لمرة واحدة (رسالة نصية أو بريد إلكتروني أو تطبيق مصادقة). أدخله هنا وسيكتبه Cryozen في الصفحة؛ لا يراه النموذج أبدًا.`,
    vaultCodeLabel: 'الرمز',
    vaultCodeFootnote:
      'تلميح: احفظ مفتاح المصادقة مع بيانات الدخول هذه في الإعدادات ← كلمات المرور وتسجيلات الدخول وسيُدخل Cryozen الرموز نيابةً عنك.',
    vaultCodeSkip: 'تخطٍ',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'انتهت المهلة في انتظار البوابة. هل `cryozen gateway` قيد التشغيل؟'
    }
  },
  errors: {
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'المهارات مجلدات من التعليمات يحمّلها Cryozen عندما يقتضي العمل ذلك.'
      },
      messaging: {
        title: 'Cryozen بعيدًا عن مكتبك',
        text: 'اربطه بـ Telegram وDiscord وSlack وغيرها — الوكيل نفسه والذاكرة نفسها.'
      },
      artifacts: {
        title: 'كل ما صنعه Cryozen',
      ...
      profiles: {
        ...
        text: 'كل واحد منها Cryozen مستقل — مفاتيحه وذاكرته وجلساته الخاصة.'
      },
      'composer-mentions': {
