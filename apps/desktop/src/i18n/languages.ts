import { LOCALE_ENDONYMS } from '@cryozen/shared/i18n'
...
const LOCALE_ALIASES: Record<string, Locale> = {
  ...
  'en-us': 'en',
  en_us: 'en',
  // Chinese is not shipped. A saved or OS Chinese tag lands on the English
  // fallback explicitly, rather than falling through to the OS language.
  zh: 'en',
  'zh-cn': 'en',
  zh_cn: 'en',
  'zh-hans': 'en',
