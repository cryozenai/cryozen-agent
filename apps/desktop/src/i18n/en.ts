...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Cryozen to use.',
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'In the Cryozen catalog',
    ...
    page: {
      ...
      noMatchBody: 'Nothing here matches. Point Cryozen at your own MCP server to add it.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `What Cryozen may do with ${name}`,
      summaryPreviewTitle: (name: string) => `What Cryozen could do with ${name} once you connect`,
  ...
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Cryozen and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Cryozen.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Cryozen. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Cryozen',
    continue: 'Continue in Cryozen',
  ...
  boot: {
    ready: 'Cryozen Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Cryozen settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Cryozen backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingCryozenDesktop: 'Starting Cryozen Desktop…'
    },
    errors: {
      backgroundExited:
        'The service that runs your chats closed unexpectedly. Restart it to keep going — your chats and settings are safe.',
      backgroundExitedDuringStartup: 'Cryozen stopped right after it started.',
      backendStopped: 'Cryozen stopped working in the background',
      restartCryozen: 'Restart Cryozen',
      openLogs: 'Open logs',
      desktopBootFailed: "Cryozen couldn't start",
      gatewayConnectionLost: 'Cryozen lost its connection',
      ...
      gatewaySignInRequired: 'Your remote Cryozen signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "Cryozen Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "Cryozen' background service stopped right after starting.",
      timedOut: "Cryozen' background service didn't answer in time.",
      permission: "Cryozen couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so Cryozen could not start.',
      portInUse: 'Another program is using the network port Cryozen needs.',
      installMissing: "Part of Cryozen' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "Cryozen couldn't start",
      description:
        "Cryozen' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Cryozen backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateCryozen: 'Update Cryozen',
    ...
    errors: {
      ...
      storageFailure: "Cryozen couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This Cryozen no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed:
        "Cryozen' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired:
        'Cryozen was updated but is still running the old version. Restart it to finish the update.',
      rpcOutOfSync: 'The app and the backend are on different versions. Update both.',
      restartCryozenFailed: "Couldn't restart Cryozen"
    },
    actions: {
      restartCryozen: 'Restart Cryozen',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Cryozen',
    ...
    native: {
      ...
      inputBody: 'Cryozen is waiting for your response.',
      turnDoneTitle: 'Cryozen finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Cryozen defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Cryozen catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Cryozen generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Cryozen picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Cryozen.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Cryozen closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Cryozen is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Cryozen asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Cryozen was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Cryozen was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Cryozen follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Cryozen can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Cryozen. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Cryozen spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Cryozen is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Cryozen, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallCryozen: 'Uninstall Cryozen'
    },
    poolLimits: {
    ...
    about: {
      heading: 'Cryozen Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Cryozen runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Cryozen only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Cryozen',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Cryozen checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Minimize windows or close the main window to hide them in the system tray (menu bar on macOS) and keep Cryozen running. Use Quit Cryozen from the tray menu or Cmd+Q to exit. Off by default; applies only to this device.',
      ...
      loading: 'Loading Cryozen configuration...',
    ...
    hudModifier: {
      ...
      permission:
        'Allow Cryozen in System Settings → Privacy & Security → Input Monitoring, then retry. This gesture does not record keystrokes or capture your screen.',
      unavailable:
        'The HUD gesture helper could not start or stopped unexpectedly. Retry, or restart Cryozen. The existing HUD shortcut still works inside Cryozen.',
      missingHelper:
        'This Cryozen installation is missing the HUD gesture helper. Update or reinstall Cryozen, then retry.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current Cryozen draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets Cryozen detect both Command keys while another app is active. Allow Cryozen in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets Cryozen capture the frontmost app window when you use this shortcut. Allow Cryozen in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart Cryozen if macOS asks.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Cryozen.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Cryozen gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      kindSsh: 'SSH',
      kindLocalDesc: 'The Cryozen runtime managed by this app.',
      kindRemoteDesc: 'A Cryozen gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindSshDesc: 'A Cryozen install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Cryozen manages (Authorization, Cookie, Host…) are ignored.',
    ...
    gateway: {
      ...
      unavailableDesc:
        'Connection settings can only be changed from the Cryozen Desktop app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a Cryozen backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way Cryozen was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart Cryozen without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Cryozen backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Cryozen backend.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /cryozen.',
      probing: 'Checking how this gateway authenticates…',
      probeError:
        "Cryozen can't reach that address. Check the URL and that the other computer is running Cryozen — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'Cryozen Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Cryozen ${version}` : ''}`,
      ...
      sshDesc:
        'Cryozen is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshCryozenPathTitle: 'Cryozen path (optional)',
      sshCryozenPathDesc: 'Full path to the remote cryozen binary. Blank = auto-detect.',
      sshCryozenPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Cryozen found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Cryozen runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Cryozen is not installed on the remote host. Install it there (curl -fsSL https://cryozenai.github.io/cryozen-agent/install.sh | sh) or set the Cryozen path.',
      sshErrPlatform:
        'Unsupported remote platform. Cryozen Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Cryozen on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Cryozen. Review the exact configuration below — it comes from the link, not from Cryozen.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Cryozen starts and manages the server for you.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Cryozen runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Cryozen at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Cryozen can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Cryozen browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via cryozen curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Cryozen (default)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Cryozen to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Cryozen catalog${sha ? ` at pin ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D is not in the Cryozen plugin catalog. Nothing was installed.`,
      deepLinkCatalogUnavailable:
        'Could not load the Cryozen plugin catalog. Check your connection and open the link again.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Cryozen builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Cryozen to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Cryozen to generate pets.',
      backgroundHint: 'You can close this — Cryozen will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Cryozen desktop' },
    ...
    cryozenActiveSessions: (version, count) => `Cryozen ${version} · Active sessions ${count}`,
    ...
    usageEmpty: period => `No usage in the last ${period} days.`,
    retry: 'Retry',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@cryozen:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Cryozen you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://cryozen.example.com',
    ...
    defaultDescription: 'Used when Cryozen opens and for new chats. Existing sessions stay in their profiles.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Cryozen environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  modelAssignment: {
    saveFailed: 'Cryozen did not save that model change.',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Cryozen will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Cryozen backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Cryozen. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Cryozen backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Cryozen...',
    placeholderReconnecting: 'Reconnecting to Cryozen…',
    ...
    voiceEngineChained: 'Speech-to-text + Cryozen voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Cryozen)',
    ...
    attachUrlDesc: 'Cryozen will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Cryozen to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Cryozen…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Cryozen…',
    ...
    unsupportedMessage: 'This version of Cryozen can’t update itself from inside the app.',
    connectionRetry:
      "Cryozen couldn't reach the update server. Check your internet connection and try again. If you use a remote Cryozen, make sure it is online.",
    gitUnusable: 'Cryozen could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
    ...
    manualBody: 'You installed Cryozen from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Cryozen will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Cryozen desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Cryozen updater takes over in its own window and reopens Cryozen automatically when it’s done. Please don’t reopen Cryozen yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Cryozen reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Cryozen reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Cryozen?',
    blockerBody:
      'Cryozen needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Cryozen',
    foreignBlockerBody:
      'Cryozen can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Cryozen can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Cryozen needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Cryozen Desktop',
    setupChoiceDesc:
      'Connect this app to a Cryozen gateway you already run, or install Cryozen locally on this computer.',
    connectExistingTitle: 'Connect to existing Cryozen',
    ...
    installLocalTitle: 'Install Cryozen locally',
    installLocalDesc: 'Download Cryozen, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Cryozen Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Cryozen',
    remoteSetupDesc: 'Enter your gateway URL. Cryozen Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Cryozen gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/cryozen',
    ...
    settingUpTitle: 'Setting up Cryozen Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Cryozen is running, the internet connection dropped, or antivirus blocked the installer. Close other Cryozen windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Cryozen Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Cryozen is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Cryozen…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description:
          'Point Cryozen at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Cryozen connects automatically',
    ...
    authorizeThere: 'Authorize Cryozen there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Cryozen there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Cryozen Desktop v${version}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Cryozen will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Cryozen is restarting...',
      askRestart: 'Ask Cryozen to restart the server',
      lookingRestart: taskId => `Cryozen is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Cryozen is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Cryozen to open a page.',
      finishedRestarting: message => `Cryozen finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Cryozen could not restart the server.',
      stillWorking:
        'Cryozen is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  interfaceMode: {
    ...
    hint: 'Changes what is shown, not what Cryozen can do.',
    sessionNote: 'Set by Simple mode. A change here lasts for this session; switch to Advanced to make it yours.',
    simple: {
      label: 'Simple',
      description: 'For talking to Cryozen. Sidebar and chat; no terminal, file or diff panes.'
    },
    advanced: {
      label: 'Advanced',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Cryozen is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'Cryozen hit a problem',
        generic: "Cryozen couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'Cryozen hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so Cryozen could not save this conversation. Free some space, then retry.',
        endpoint:
          "Cryozen can't reach your custom model server. Check that it is running, then send your message again.",
        gateway:
          'Cryozen hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while Cryozen was replying. Retry, or copy the details if it keeps happening.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Cryozen could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something Cryozen could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Cryozen got stuck in a loop',
          body: 'The reply kept repeating the same steps, so Cryozen stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another Cryozen window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so Cryozen could not save this conversation. Free some space, then retry.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorToastTitle: "Cryozen couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenCryozenFolder: 'Open Cryozen folder',
      errorOpenCryozenFolderFailed: 'Could not open the Cryozen folder',
    ...
    approval: {
      gatewayDisconnected:
        'Cryozen is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask Cryozen to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.cryozen-agent/config.yaml). Cryozen won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'Cryozen is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'Cryozen needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Cryozen reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Cryozen types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Cryozen enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Cryozen Desktop to use Save Image.',
    restartToSaveImages: 'Restart Cryozen Desktop to save images',
    ...
    handoff: {
      ...
      timedOut:
        "Cryozen couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Cryozen loads when the work calls for them.'
      },
      messaging: {
        title: 'Cryozen away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Cryozen made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Cryozen — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
