/**
 * Canonical Cryozen skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$CRYOZEN_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`cryozen_cli/skin_engine.py`),
 ...
 *   • CLI     → `cryozen_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
