/**
 * Raw palette table for every built-in Cryozen theme preset — the single source
 ...
 *
 * The palette-bearing presets (cryozen, github, catppuccin, everforest, solarized)
 ...
 * than hand-editing hexes. `cryozen-alt` is first-party — do not re-derive it.
 */
...
export interface ThemePresetPalette {
  ...
  /** Hand-tuned dark palette. Skins like `cryozen` ship one. */
  darkColors?: ThemePresetColors
}

const BRAND_ALT_BLUE = '#0053FD'
const BRAND_ALT_NAVY = '#1540B1'
const BRAND_ALT_CREAM = '#FFE6CB'

const brandAltTint = (pct: number) => `color-mix(in srgb, ${BRAND_ALT_BLUE} ${pct}%, #FFFFFF)`
const brandAltTintTransparent = (pct: number) => `color-mix(in srgb, ${BRAND_ALT_BLUE} ${pct}%, transparent)`
...
export const THEME_PRESET_PALETTES = {
  ...
  'cryozen-alt': {
    colors: {
      ...
      muted: brandAltTint(5),
      mutedForeground: '#666678',
      popover: '#FFFFFF',
      popoverForeground: '#17171A',
      primary: BRAND_ALT_BLUE,
      primaryForeground: '#FCFCFC',
      secondary: brandAltTint(7),
      secondaryForeground: '#242432',
      accent: brandAltTint(10),
      accentForeground: '#202030',
      border: brandAltTintTransparent(22),
      input: brandAltTintTransparent(30),
      ring: BRAND_ALT_BLUE,
      midground: BRAND_ALT_BLUE,
      composerRing: BRAND_ALT_BLUE,
      destructive: '#C72E4D',
      destructiveForeground: '#FFFFFF',
      sidebarBackground: '#F3F7FF',
      sidebarBorder: brandAltTintTransparent(18),
      userBubble: brandAltTint(6),
      userBubbleBorder: brandAltTintTransparent(24)
    },
    darkColors: {
      background: '#0D2F86',
      foreground: BRAND_ALT_CREAM,
      card: '#12378F',
      cardForeground: BRAND_ALT_CREAM,
      muted: '#183F9A',
      mutedForeground: '#B5C7F3',
      popover: '#123A96',
      popoverForeground: BRAND_ALT_CREAM,
      primary: BRAND_ALT_CREAM,
      primaryForeground: '#0D2F86',
      secondary: '#1B45A4',
      secondaryForeground: '#E0E8FF',
      accent: BRAND_ALT_NAVY,
      accentForeground: '#F0F4FF',
      border: '#3158AD',
      input: '#0B2566',
      ring: BRAND_ALT_CREAM,
      midground: BRAND_ALT_BLUE,
      composerRing: BRAND_ALT_CREAM,
      destructive: '#C0473A',
