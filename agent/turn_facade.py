...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        try:
            ...
            # Ambient conversation context: every LLM call in this turn (loop, compression,
            ...
            # A host that owns this thread (Cryozen Console) may cancel the turn cross-thread.
