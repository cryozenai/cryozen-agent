...
A host that runs a blocking command on a worker thread (Cryozen Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("cryozen_interrupt_scope", default=None)
