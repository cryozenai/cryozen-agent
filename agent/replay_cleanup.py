...
_DANGLING_NOTICES = (
    "[Orphan recovery: this tool may have executed before Cryozen stopped; its effect is UNKNOWN. Inspect current state before retrying.]",
...
# interrupted]" (tools/environments/, exit 130), "[execution interrupted ...]"
# (code_execution_tool.py, exit -1).
