...
# Auto-detect order when ``browser.cloud_provider`` is unset (historic order: Browser Use first;
# Browserbase as the older direct-credentials fallback). Firecrawl is deliberately absent — see :func:`_resolve`.
