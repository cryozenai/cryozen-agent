...
The memo carries the model because capability is per model on aggregators (openrouter.ai,
api.openai.com host dozens of models with different structured-output support), and it is
