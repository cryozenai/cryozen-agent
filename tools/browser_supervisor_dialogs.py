...
DIALOG_BRIDGE_HOST = "cryozen-dialog-bridge.invalid"
...
(() => {
  if (window.__cryozenDialogBridgeInstalled) return;
  window.__cryozenDialogBridgeInstalled = true;
  const ENDPOINT = "http://cryozen-dialog-bridge.invalid/";
