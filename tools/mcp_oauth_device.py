...
started by `cryozen mcp login/reauth`, never a background reconnect.
"""
...
async def login_device(name, server_url, oauth_config):
    ...
    from tools.mcp_oauth_manager import CryozenMCPOAuthProvider, get_manager
    ...
    provider = CryozenMCPOAuthProvider(server_url=server_url, server_name=name, storage=storage,
