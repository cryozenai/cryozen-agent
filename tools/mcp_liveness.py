...
from cryozen_platform.resolver.app import AppDef, AppResolver
from cryozen_platform.resolver.availability import Availability, availability
from cryozen_platform.resolver.base import Effort
from cryozen_platform.resolver.core import CheckState
...
def liveness_for(server_name: str) -> Liveness:
    ...
    try:
        from cryozen_cli.agent_plugins import liveness_for as registered_liveness
    except ImportError:
        return Liveness("static")
