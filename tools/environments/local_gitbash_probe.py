...
from cryozen_cli._subprocess_compat import bounded_probe_run, windows_hide_flags
...
def _git_bash_aslr_help(bash: str, details: str = "") -> str:
    ...
    return (
        ...
        "Then restart Cryozen. If the override is blocked or later re-applied, "
...
def _bash_starts(bash: str) -> bool:
    ...
    try:
        ...
        # (strace on #73403). stderr stays captured: the Mandatory-ASLR
