...
# containing `cat ~/.cryozen-agent/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `cryozen-agent-dev` skill contains a security postmortem mentioning `cat ~/.cryozen-agent/.env`, which tripped
