...
_NEEDS_REAUTH_MSG = (
    "MCP server '{s}' requires re-authentication. Run `cryozen mcp login {s}` (or delete the tokens file under "
    "~/.cryozen-agent/mcp-tokens/ and restart). Do NOT retry this tool — ask the user to re-authenticate.")
...
_STDIO_OUTCOME_UNCERTAIN_MSG = (
    ...
    "Cryozen did not replay it. Do NOT retry automatically; inspect the external state first.")
