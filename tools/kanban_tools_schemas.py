...
_DESC_TASK_ID_DEFAULT = (
    "Task id. If omitted, defaults to CRYOZEN_KANBAN_TASK from the env "
    "(the task the dispatcher spawned you to work on)."
)

_DESC_BOARD = (
    "Kanban board slug to target. When omitted, the call resolves the "
    "active board the usual way: CRYOZEN_KANBAN_DB env → "
    "CRYOZEN_KANBAN_BOARD env → the 'current' symlink under the kanban "
    ...
    ),
    {
        ...
        "artifacts": {
            ...
            "description": (
                ...
                "Examples: [\"~/.cryozen-agent/cache/scratch/q3-revenue.png\", "
                "\"~/.cryozen-agent/cache/scratch/report.pdf\"]. The gateway notifier "
    ...
    ),
    {
        ...
        "artifacts": {
            ...
            "description": (
                ...
                "['~/.cryozen-agent/cache/scratch/q3-revenue.png', '~/.cryozen-agent/cache/scratch/report.pdf']. "
...
KANBAN_ATTACH_URL_SCHEMA = _schema(
    "kanban_attach_url",
    (
        "Attach a file to a task by URL — Cryozen downloads it server-side "
...
KANBAN_CREATE_SCHEMA = _schema(
    ...
    ),
    {
        ...
        "tenant": _prop("string", (
                ...
                "Defaults to CRYOZEN_TENANT env if set."
        )),
        ...
        "provider": _prop("string", (
                ...
                "'anthropic', 'deepseek'). Set this whenever the model "
