...
`hey_cryozen.onnx` / `hey_cryozen.tflite` — the on-device "Hey Cryozen" hotword
...
- **Label:** the model registers as `hey_cryozen` (matches the filename).
