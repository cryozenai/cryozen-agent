...
LOCAL_STT_COMMAND_ENV = "CRYOZEN_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "CRYOZEN_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via cryozen_cli.models.deepinfra_base_url (shared).
