...
def _anydoc_missing_error(path: str) -> str:
    ...
    return (
        ...
        "firecrawl-anydoc` in Cryozen's environment, or convert the file "
...
def _hosted_ocr_config() -> tuple:
    ...
    is a direct ``FIRECRAWL_API_KEY`` (anydoc defaults api_url). ``file_tools.hosted_ocr: false`` disables even with a
