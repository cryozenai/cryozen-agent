...
Used by cryozen_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "CRYOZEN_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"CRYOZEN_HOME": _cryozen_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'CRYOZEN_INDEX_TTL': ('tools.skills_hub_search', 'CRYOZEN_INDEX_TTL'),
    'CRYOZEN_INDEX_URL': ('tools.skills_hub_search', 'CRYOZEN_INDEX_URL'),
    'CryozenIndexSource': ('tools.skills_hub_official', 'CryozenIndexSource'),
