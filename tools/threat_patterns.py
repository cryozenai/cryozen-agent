...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|CRYOZEN|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.cryozen-agent/\.env|\~/\.cryozen-agent/\.env', "cryozen_env", "strict"),
    (rf'{_MODIFY}(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (rf'{_MODIFY}\.cryozen-agent/(config\.yaml|SOUL\.md)', "cryozen_config_mod", "strict"),
