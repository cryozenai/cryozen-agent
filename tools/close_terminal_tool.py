"""Close a read-only agent terminal tab in the Cryozen desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the Cryozen desktop GUI (the tabs mirroring terminal(background=true) runs). "
