...
KINDS: Tuple[str, ...] = ("mcp", "plugin", "skill")
...
# backend: the install / enable / OAuth worker for an MCP target. The card can only skip a target,
# or ask for a failed one to be run again.
