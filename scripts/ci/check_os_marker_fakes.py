...
_BASELINE = frozenset(
    {
        "tests/cryozen_cli/test_doctor.py",
        "tests/cryozen_cli/test_gateway.py",
        "tests/cryozen_cli/test_gateway_proc_fallback.py",
        "tests/cryozen_cli/test_linux_sandbox_fixup.py",
        "tests/cryozen_cli/test_macos_fda_guidance.py",
        "tests/cryozen_cli/test_orphan_desktop_serve_reap.py",
        "tests/cryozen_cli/test_update_launchd_restart_verification.py",
        "tests/cryozen_cli/test_update_launchd_unloaded_gateway.py",
        "tests/cryozen_cli/test_urllib_security.py",
        "tests/cryozen_state/test_state_synchronous_pragma.py",
        "tests/test_cryozen_constants.py",
