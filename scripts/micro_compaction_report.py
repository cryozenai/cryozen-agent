#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Cryozen logs.
...
With no LOGFILE, reads ``$CRYOZEN_HOME/logs/agent.log`` (default ~/.cryozen-agent).
...
def default_log() -> Path:
    home = os.environ.get("CRYOZEN_HOME") or str(Path.home() / ".cryozen-agent")
