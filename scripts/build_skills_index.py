#!/usr/bin/env python3
"""Build the Cryozen Skills Index — a centralized JSON catalog of all skills.
...
`cryozen skills search/install` can use it without hitting the GitHub API.
...
# Ensure CRYOZEN_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Cryozen Skills Index...", flush=True)
