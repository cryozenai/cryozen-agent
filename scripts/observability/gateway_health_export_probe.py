...
def main() -> None:
    ...
    cryozen_home = Path(tempfile.mkdtemp(prefix="cryozen-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "cryozen-gateway-smoke",
    ...
    print(json.dumps({"cryozen_home": str(cryozen_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
