import { Box, type ScrollBoxHandle, stringWidth, Text } from '@cryozen/ink'
import { compactNumber } from '@cryozen/shared/format'
import type { Usage } from '@cryozen/shared/gateway-events'
...
// Colour a status notice by its level. The notice TEXT already carries its
...
// a clamped Cryozen step such as `ultra` reads `ultra→max`, like the CLI's
...
export function StatusRule({
  ...
  // A status notice replaces the status/verb slot, but only when idle —
