 ...
 *
 * Symptom: in `cryozen --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@cryozen/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using cryozen --tui and as i type multiline my caret at the end will often ' +
