import type { MessageCompletePayload, SubagentEventPayload, ToolLabel } from '@cryozen/shared/gateway-events'
...
class TurnController {
  ...
  // The Python side emits STABLE ids per notice kind, NOT unique-per-emission ids.  The id-guard in
