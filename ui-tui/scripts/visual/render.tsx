 ...
 * across theme x background scenes to <tmpdir>/cryozen-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@cryozen/ink'
...
// The regenerated slate light_colors block from cryozen_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/cryozen-agent',
...
const setup = (bgHex: string) => {
  process.env.CRYOZEN_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
