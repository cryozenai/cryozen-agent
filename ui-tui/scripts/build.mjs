...
await build({
  ...
  // Skip the prebuilt @cryozen/ink bundle and inline the source instead:
  ...
  alias: { '@cryozen/ink': resolve(root, 'packages/cryozen-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The cryozen_cli launcher
