...
a plugin, a tool reading ``~/.cryozen-agent`` — cancels both (sqlite.org/howtocorrupt.html §2.2) and the
...
# cryozen_state dies before supported() can say "no" (#118026) — so tolerate a missing attribute
