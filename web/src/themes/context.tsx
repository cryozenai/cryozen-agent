...
const STORAGE_KEY = "cryozen-dashboard-theme";
...
const FONT_STORAGE_KEY = "cryozen-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Legacy ids of the Cryozen Blue preset from before the rename.
  "lens-5i": "cryozen-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `cryozen_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "cryozen-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-cryozen-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-cryozen-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Cryozen Blue) doesn't leave its values behind when the user
