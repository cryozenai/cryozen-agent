import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@cryozen/shared";
 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `cryozen_cli/web_server.py`.
 *
 * Presets that also ship on the desktop (midnight, ember, mono, cyberpunk)
 * take their colours from `@cryozen/shared` `THEME_PRESET_PALETTES` so both
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Cryozen Teal",
  description: "Classic dark teal — the canonical Cryozen look",
  palette: {
...
export const cryozenBlueTheme: DashboardTheme = {
  name: "cryozen-blue",
  label: "Cryozen Blue",
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Cryozen Teal (Large)",
  description: "Cryozen Teal with bigger fonts and roomier spacing",
