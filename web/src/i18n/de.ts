...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateCryozen: "Cryozen aktualisieren",
    updatingCryozen: "Cryozen wird aktualisiert…",
  ...
  analytics: {
    ...
    output: "Ausgabe",
    total: "Gesamt",
    usageDataEmpty: "Keine Nutzungsdaten für diesen Zeitraum",
  ...
  pluginsPage: {
    ...
    headline:
      "Cryozen-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `cryozen plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.cryozen-agent/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.cryozen-agent/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.cryozen-agent/skills/ geladen",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die Cryozen nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
