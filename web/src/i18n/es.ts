...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateCryozen: "Actualizar Cryozen",
    updatingCryozen: "Actualizando Cryozen…",
  ...
  analytics: {
    ...
    output: "Salida",
    total: "Total",
    usageDataEmpty: "No hay datos de uso para este período",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Cryozen (equivalente a `cryozen plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.cryozen-agent/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.cryozen-agent/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.cryozen-agent/skills/",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que Cryozen no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
