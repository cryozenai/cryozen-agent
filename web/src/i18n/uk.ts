...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateCryozen: "Оновити Cryozen",
    updatingCryozen: "Оновлення Cryozen…",
  ...
  analytics: {
    ...
    output: "Вихід",
    total: "Усього",
    usageDataEmpty: "Немає даних про використання за цей період",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Cryozen (паритет з `cryozen plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.cryozen-agent/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.cryozen-agent/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.cryozen-agent/skills/",
  ...
  env: {
    ...
    customHint: "Довільні змінні середовища, збережені у вашому .env, які Cryozen не розпізнає. Використовуйте їх для впровадження змінних середовища для навичок, серверів MCP або власних інструментів.",
