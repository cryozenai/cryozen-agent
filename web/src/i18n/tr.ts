...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateCryozen: "Cryozen'i Güncelle",
    updatingCryozen: "Cryozen güncelleniyor…",
  ...
  analytics: {
    ...
    output: "Çıkış",
    total: "Toplam",
    usageDataEmpty: "Bu dönem için kullanım verisi yok",
  ...
  pluginsPage: {
    ...
    headline:
      "Cryozen eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`cryozen plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.cryozen-agent/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.cryozen-agent/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.cryozen-agent/skills/ adresinden yüklenir",
  ...
  env: {
    ...
    customHint: ".env dosyanızda saklanan ve Cryozen'in tanımadığı rastgele ortam değişkenleri. Bunları beceriler, MCP sunucuları veya kendi araçlarınız için ortam değişkenleri eklemek için kullanın.",
