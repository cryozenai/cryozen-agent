...
export const ru: Translations = {
  ...
  status: {
    ...
    updatingCryozen: "Обновление Cryozen…",
  ...
  analytics: {
    ...
    output: "Вывод",
    total: "Итого",
    usageDataEmpty: "Нет данных об использовании за этот период",
  ...
  pluginsPage: {
    ...
    headline:
      "Поиск, установка, включение и обновление плагинов Cryozen (аналог `cryozen plugins`).",
    ...
    removeConfirm: "Удалить этот плагин из ~/.cryozen-agent/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.cryozen-agent/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.cryozen-agent/skills/",
  ...
  env: {
    ...
    customHint: "Произвольные переменные окружения, сохранённые в вашем .env, которые Cryozen не распознаёт. Используйте их для внедрения переменных окружения для навыков, серверов MCP или собственных инструментов.",
