...
export const ja: Translations = {
  ...
  status: {
    ...
    updatingCryozen: "Cryozen を更新しています…",
  ...
  analytics: {
    ...
    output: "出力",
    total: "合計",
    usageDataEmpty: "この期間の使用データはありません",
  ...
  pluginsPage: {
    ...
    headline:
      "Cryozen プラグインを発見、インストール、有効化、更新します (`cryozen plugins` 相当)。",
    ...
    removeConfirm: "このプラグインを ~/.cryozen-agent/plugins/ から削除しますか？",
    removeHint: "削除できるのは ~/.cryozen-agent/plugins 配下のユーザーがインストールしたプラグインのみです。",
  ...
  skills: {
    ...
    categories: "カテゴリ",
    filters: "フィルター",
    noSkills: "スキルが見つかりません。スキルは ~/.cryozen-agent/skills/ から読み込まれます",
  ...
  env: {
    ...
    hideValue: "値を非表示",
    customTitle: "カスタムキー",
    customHint: "Cryozen が認識しない、.env に保存された任意の環境変数。スキル、MCP サーバー、または独自のツール用に環境変数を注入するために使用します。",
