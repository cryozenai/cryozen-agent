...
export const ar = defineLocale({
  ...
  status: {
    ...
    updatingCryozen: "جاري تحديث Cryozen…",
  ...
  analytics: {
    ...
    output: "إخراج",
    total: "الإجمالي",
    usageDataEmpty: "لا توجد بيانات استخدام لهذه الفترة",
  ...
  pluginsPage: {
    ...
    headline:
      "اكتشف وثبِّت وفعِّل وحدِّث مكوِّنات Cryozen الإضافية (مطابقة `cryozen plugins`).",
    ...
    removeConfirm: "إزالة هذا المكوِّن الإضافي من ~/.cryozen-agent/plugins/؟",
    removeHint: "يمكن إزالة المكوِّنات المثبتة من المستخدم تحت ~/.cryozen-agent/plugins فقط.",
  ...
  skills: {
    ...
    categories: "الفئات",
    filters: "الفلاتر",
    noSkills: "لم يُعثر على مهارات. يتم تحميل المهارات من ~/.cryozen-agent/skills/",
