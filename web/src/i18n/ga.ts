...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateCryozen: "Nuashonraigh Cryozen",
    updatingCryozen: "Ag nuashonrú Cryozen…",
  ...
  analytics: {
    ...
    output: "Aschur",
    total: "Iomlán",
    usageDataEmpty: "Gan sonraí úsáide don tréimhse seo",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Cryozen (paireacht le `cryozen plugins`).",
    ...
    removeConfirm: "Bain an plugin seo ó ~/.cryozen-agent/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.cryozen-agent/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.cryozen-agent/skills/",
  ...
  env: {
    ...
    customHint: "Athróga timpeallachta treallach atá stóráilte i do .env nach n-aithníonn Cryozen. Úsáid iad chun athróga timpeallachta a instealladh do scileanna, freastalaithe MCP, nó d'uirlisí féin.",
