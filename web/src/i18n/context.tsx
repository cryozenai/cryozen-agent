import { applyDocumentLocale, LOCALE_ENDONYMS } from "@cryozen/shared/i18n";
...
// Display metadata for the language picker — endonyms from @cryozen/shared so the
...
const STORAGE_KEY = "cryozen-locale";
