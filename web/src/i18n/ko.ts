...
export const ko: Translations = {
  ...
  status: {
    ...
    stopped: "중지됨",
    updateCryozen: "Cryozen 업데이트",
    updatingCryozen: "Cryozen 업데이트 중…",
  ...
  analytics: {
    ...
    output: "출력",
    total: "합계",
    usageDataEmpty: "이 기간에 대한 사용 데이터가 없습니다",
  ...
  pluginsPage: {
    ...
    headline:
      "Cryozen 플러그인을 검색, 설치, 활성화 및 업데이트합니다 (`cryozen plugins` 동등).",
    ...
    removeConfirm: "~/.cryozen-agent/plugins/에서 이 플러그인을 제거하시겠습니까?",
    removeHint: "~/.cryozen-agent/plugins 아래에 사용자가 설치한 플러그인만 제거할 수 있습니다.",
  ...
  skills: {
    ...
    categories: "카테고리",
    filters: "필터",
    noSkills: "스킬을 찾을 수 없습니다. 스킬은 ~/.cryozen-agent/skills/ 에서 로드됩니다",
  ...
  env: {
    ...
    customHint: "Cryozen가 인식하지 못하는, .env에 저장된 임의의 환경 변수입니다. 스킬, MCP 서버 또는 자체 도구를 위한 환경 변수를 주입하는 데 사용하세요.",
