...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateCryozen: "Mettre à jour Cryozen",
    updatingCryozen: "Mise à jour de Cryozen…",
  ...
  analytics: {
    ...
    output: "Sortie",
    total: "Total",
    usageDataEmpty: "Aucune donnée d'utilisation pour cette période",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Cryozen (parité avec `cryozen plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.cryozen-agent/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.cryozen-agent/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.cryozen-agent/skills/",
  ...
  env: {
    ...
    customHint: "Variables d'environnement arbitraires stockées dans votre .env que Cryozen ne reconnaît pas. Utilisez-les pour injecter des variables d'environnement pour des compétences, des serveurs MCP ou vos propres outils.",
