...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateCryozen: "Atualizar Cryozen",
    updatingCryozen: "A atualizar Cryozen…",
  ...
  analytics: {
    ...
    output: "Saída",
    total: "Total",
    usageDataEmpty: "Sem dados de utilização para este período",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Cryozen (paridade com `cryozen plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.cryozen-agent/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.cryozen-agent/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.cryozen-agent/skills/",
  ...
  env: {
    ...
    customHint: "Variáveis de ambiente arbitrárias armazenadas no seu .env que o Cryozen não reconhece. Use-as para injetar variáveis de ambiente para skills, servidores MCP ou suas próprias ferramentas.",
