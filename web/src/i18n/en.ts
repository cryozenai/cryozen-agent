...
export const en: Translations = {
  ...
  status: {
    ...
    updateCryozenConfirmMessage:
      "This runs cryozen update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateCryozenConfirmNow: "Update now",
    updateCryozenConfirmTitle: "Update Cryozen?",
    updatingCryozen: "Updating Cryozen…",
  ...
  analytics: {
    ...
    output: "Output",
    total: "Total",
    usageDataEmpty: "No usage data for this period",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Cryozen plugins (`cryozen plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.cryozen-agent/plugins/?",
    removeHint: "Only user-installed plugins under ~/.cryozen-agent/plugins can be removed.",
    ...
    catalogEmptyDocsLink: "Learn about Cryozen plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills installed yet. Browse the skills hub or create one here; from a terminal you can also run `cryozen skills search <topic>`.",
  ...
  config: {
    configPath: "~/.cryozen-agent/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Cryozen doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
