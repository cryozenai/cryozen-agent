...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateCryozen: "Aggiorna Cryozen",
    updatingCryozen: "Aggiornamento di Cryozen…",
  ...
  analytics: {
    ...
    output: "Output",
    total: "Totale",
    usageDataEmpty: "Nessun dato di utilizzo per questo periodo",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Cryozen (parità con `cryozen plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.cryozen-agent/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.cryozen-agent/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.cryozen-agent/skills/",
  ...
  env: {
    ...
    customHint: "Variabili d'ambiente arbitrarie salvate nel tuo .env che Cryozen non riconosce. Usale per iniettare variabili d'ambiente per skill, server MCP o i tuoi strumenti.",
