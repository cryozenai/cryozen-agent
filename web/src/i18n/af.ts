...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateCryozen: "Werk Cryozen op",
    updatingCryozen: "Besig om Cryozen op te werk…",
  ...
  analytics: {
    ...
    output: "Uitset",
    total: "Totaal",
    usageDataEmpty: "Geen gebruiksdata vir hierdie tydperk nie",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Cryozen-inproppe op (`cryozen plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.cryozen-agent/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.cryozen-agent/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.cryozen-agent/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrêre omgewingsveranderlikes wat in jou .env gestoor is en wat Cryozen nie herken nie. Gebruik dit om omgewingsveranderlikes vir vaardighede, MCP-bedieners of jou eie gereedskap in te spuit.",
