...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateCryozen: "Cryozen frissítése",
    updatingCryozen: "Cryozen frissítése…",
  ...
  analytics: {
    ...
    output: "Kimenet",
    total: "Összesen",
    usageDataEmpty: "Nincs használati adat erre az időszakra",
  ...
  pluginsPage: {
    ...
    headline:
      "Cryozen-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `cryozen plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.cryozen-agent/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.cryozen-agent/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.cryozen-agent/skills/ mappából töltődnek be",
  ...
  env: {
    ...
    customHint: "A .env fájlban tárolt tetszőleges környezeti változók, amelyeket a Cryozen nem ismer fel. Használd ezeket környezeti változók beillesztésére képességekhez, MCP-kiszolgálókhoz vagy saját eszközeidhez.",
