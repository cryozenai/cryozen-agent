 ...
 *
 * Values come from @cryozen/shared (cryozen_constants.VALID_REASONING_EFFORTS
 * plus `none`, thinking-off). An empty/unset config value means the Cryozen
 * default.
 */
 ...
 *  option. Empty/unknown → `medium` (Cryozen' default when unset). */
