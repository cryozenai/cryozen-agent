 ...
 * `window.__CRYOZEN_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Cryozen brand in the top bar
 ...
 *  `window.__CRYOZEN_PLUGINS__.registerSlot(...)`.
 *
