...
def step(mode):
    from cryozen_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from cryozen_cli.main import _run_logged_subprocess
