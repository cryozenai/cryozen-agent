...
os.environ["CRYOZEN_HOME"] = tempfile.mkdtemp(prefix="cryozen-e2e-55712-")
for m in [k for k in sys.modules if k.startswith(("cryozen", "tools", "plugins"))]:
    del sys.modules[m]

import uvicorn  # noqa: E402

from cryozen_cli import web_server  # noqa: E402
from cryozen_cli.dashboard_auth import register_provider  # noqa: E402
from cryozen_cli.dashboard_auth.base import RefreshExpiredError, Session  # noqa: E402
from tests.cryozen_cli.conftest_dashboard_auth import StubAuthProvider  # noqa: E402
...
idp.calls = 0
ck = "cryozen_session_at=expired-at; cryozen_session_rt=cookie-stale; cryozen_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
