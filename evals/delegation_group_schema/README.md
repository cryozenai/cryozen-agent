...
Pinned to a configured hosted `google/gemini-3.7-flash`; no provider fallback.
A separate temporary home held only copied provider authentication and minimal
