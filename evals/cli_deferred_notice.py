...
def run_case(root, output, name, behind, early=False, cancel=False):
    with tempfile.TemporaryDirectory(prefix="cryozen_test_notice_") as home:
        ...
        from cryozen_cli.banner import VERSION
        ...
        bootstrap = ("import cryozen_cli.main as m; import cryozen_cli.banner as b; "
        ...
        try:
            ...
            result = {"case": name, "ready": ready, "exited": exited,
                      ...
                      "loaded_worktree": str(root / "cryozen_cli/banner.py") in text,
