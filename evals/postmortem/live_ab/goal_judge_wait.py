...
os.environ.setdefault("CRYOZEN_HOME", os.path.expanduser("~/.cryozen-agent"))  # LIVE: real auxiliary judge calls (cents)
from cryozen_cli import goals
goal = ("Simplify the cryozen-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
