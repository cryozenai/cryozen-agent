...
# Remove all inherited Cryozen/config and credential env before real imports.
...
os.environ['CRYOZEN_HOME'] = home.name
os.environ['NO_PROXY'] = '*'
os.environ['TZ'] = 'UTC'
...
from cryozen_cli import cli_commands_mixin, goals
...
server._cryozen_home = Path(home.name)
...
with patch('cryozen_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
