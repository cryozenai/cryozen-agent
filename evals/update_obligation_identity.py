...
os.environ["CRYOZEN_HOME"] = str(root / ".cryozen-agent")
from cryozen_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".cryozen-agent" / "profiles" / name
    ...
    d = root / ".cryozen-agent/logs/update_receipts"
    ...
    home = root / ".cryozen-agent/profiles/beta"
