...
Run from a checkout with CRYOZEN_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["CRYOZEN_MAX_TOKENS"] = "13"
...
from cryozen_cli.moa_config import _normalize_preset
