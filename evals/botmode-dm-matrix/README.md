...
Scratch HOME, CRYOZEN_HOME, Python facade and CLI shims; no user profiles or credentials.
...
(cd apps/desktop && CRYOZEN_DESKTOP_CDP_PORT=off BOT_DM_SERVICE_PATH=1 \
...
worktree-pinned `cryozen`; PATH contains a different inert `cryozen` that exits 2
