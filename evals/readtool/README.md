...
benchmarked ten harnesses on hostile-file handling — and whose Cryozen column
...
Every task runs the full Cryozen agent (file + terminal + search toolsets)
...
Rules of engagement (from cryozenbench discipline):
