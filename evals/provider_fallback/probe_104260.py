...
sandbox = tempfile.TemporaryDirectory(prefix="cryozen-104260-")
os.environ.clear()
os.environ.update(
    HOME=sandbox.name,
    CRYOZEN_HOME=sandbox.name + "/cryozen",
    PATH="/usr/bin:/bin",
    PYTHONDONTWRITEBYTECODE="1",
    CRYOZEN_DISABLE_MODEL_METADATA_FETCH="1",
)
...
# JSON is valid YAML; only the temporary Cryozen home is written.
