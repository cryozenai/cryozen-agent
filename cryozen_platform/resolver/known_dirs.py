...
Every table in Cryozen lives here. A directory literal outside this module fails the ratchet in
...
def cryozen_vendored_dirs() -> tuple[str, ...]:
    return ("~/.cryozen-agent/bin",) if _POSIX else ("%USERPROFILE%/.cryozen-agent/bin",)
