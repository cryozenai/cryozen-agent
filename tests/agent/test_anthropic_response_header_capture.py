...
The OpenAI-wire streaming path captures them from ``stream.response``; the Messages
path must do the same via ``on_response`` or /status and the 429 classifier lose
last-known state.
"""
