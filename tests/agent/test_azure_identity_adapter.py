...
class TestBuildCredential:
    def test_default_kwargs_are_minimal(self, fake_azure_identity):
        ...
        azure-identity directly), not Cryozen config kwargs."""
...
# ---------------------------------------------------------------------------
# describe_active_credential — used by cryozen doctor + cryozen auth
# ---------------------------------------------------------------------------
