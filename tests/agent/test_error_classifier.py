...
class TestClassifyApiError:
        ...
        e = MockAPIError(
            ...
            body={
                ...
                "message": (
                    ...
                    "Upgrade your plan or pick a free model."
                ),
            },
        )
        ...
        e = MockAPIError(
            ...
            body={
                ...
                "message": (
                    ...
                    "add credits or pick a free model."
                ),
            },
        )
        result = classify_api_error(e, provider="openrouter", model="openai/gpt-5.5-pro")
        assert result.reason == FailoverReason.billing
        assert result.retryable is False
        assert result.should_fallback is True
    ...
    def test_reasoning_mandatory_400_is_retryable_not_format_error(self):
        ...
        result = classify_api_error(e, provider="openrouter", model="z-ai/glm-5.3-flash")
...
class TestServerInjectedParameterRejection:
    ...
    so an identical request succeeds on retry ~80% of the time.  Cryozen never
    ...
    def test_retention_rejection_from_meta_host_stays_non_retryable(self):
        """Boundary: on api.meta.ai / Bedrock Mantle Cryozen DOES send
