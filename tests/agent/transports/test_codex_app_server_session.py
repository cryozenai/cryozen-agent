...
class TestLifecycle:
    ...
    def test_thread_start_carries_cryozen_prompt_and_disables_codex_personality(self):
        """thread/start carries cwd, Cryozen' composed prompt as developerInstructions and
