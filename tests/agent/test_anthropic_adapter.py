...
class TestBuildAnthropicClient:
    def test_api_key_uses_api_key(self):
        with patch("agent.anthropic_adapter._anthropic_sdk") as mock_sdk:
            ...
            assert "user-agent" not in {k.lower() for k in kwargs["default_headers"]}
    ...
    def test_disables_sdk_retries_for_api_key(self):
        ...
        double-retries inside cryozen's outer loop. We delegate retry entirely
...
class TestConvertToolsToAnthropicDedup:
    ...
    https://github.com/cryozenai/cryozen-agent/issues/18478
    """
