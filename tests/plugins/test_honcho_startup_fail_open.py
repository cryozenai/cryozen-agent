...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "cryozen honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "cryozen honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "cryozen honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "cryozen honcho peer --user"),
])
