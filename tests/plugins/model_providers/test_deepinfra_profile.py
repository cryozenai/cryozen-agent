...
against a gateway-wide enum (``none``..``max``; Cryozen-internal ``ultra`` is rejected). The
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"enabled": True, "effort": "ultra"}, {"reasoning_effort": "max"}),  # Cryozen-internal tier clamps
