...
shutdown drain plus ``cryozen.cron.jobs.running`` saw phantom work.
"""
...
class _Scope:
    ...
    def __enter__(self):
        self._token = set_cryozen_home_override(self._home)
        return self

    def __exit__(self, *_exc):
        reset_cryozen_home_override(self._token)
        return False
...
def test_pool_worker_release_clears_the_ticked_profiles_claim(tmp_path):
    ...
    def _process_job(j):
        ...
        ran_in["home"] = str(sched._get_cryozen_home())
