...
These drive the real store (``jobs.json`` under a temp CRYOZEN_HOME) so the assertion is the
...
def temp_home(tmp_path, monkeypatch):
    """Isolated CRYOZEN_HOME so jobs.json/executions don't touch the real store."""
