...
the shared /blueprint command handler (cryozen_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated CRYOZEN_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("cryozen://blueprint/morning-brief?")
