"""The `cryozen-agent` skill is what a running Cryozen knows about itself.

`website/` is never packaged, so an installed Cryozen has no local copy of the
user guide; skills ARE synced into `$CRYOZEN_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Cryozen can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "cryozen-agent"
