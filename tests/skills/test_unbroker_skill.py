...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and cryozen-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # cryozen-agent (tests/skills/)
]
