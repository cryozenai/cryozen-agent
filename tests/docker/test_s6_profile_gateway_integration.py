...
The unit tests in tests/cryozen_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned cryozen-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/cryozen")
from cryozen_cli.service_manager import S6ServiceManager
