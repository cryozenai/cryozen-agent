"""``$CRYOZEN_HOME`` model-provider plugins resolve for the profile home bound at lookup time (#88143).
...
profile was ``Unknown provider`` from Desktop while ``cryozen -p <profile>`` in a terminal worked.
"""
