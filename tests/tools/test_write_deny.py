...
class TestWriteDenyExactPaths:
    ...
    def test_cryozen_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.cryozen-agent/.env`` (whose credentials are inherited by every profile)
        ...
        # Sanity check: CRYOZEN_HOME does point to the profile dir, not the root.
        from cryozen_constants import get_cryozen_home, get_default_cryozen_root
...
class TestWriteAllowed:
    ...
    def test_cryozen_control_files_requested_writable(self):
