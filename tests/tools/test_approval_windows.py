...
must match regardless of host OS (a Linux-hosted Cryozen can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\cryozen\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/cryozen/.env",
    ])
