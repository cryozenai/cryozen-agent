...
``cryozen -p B`` child built from profile A's process enforced A's channel list as its own.
"""
...
def homes(tmp_path, monkeypatch):
    """Launch home A (the process's CRYOZEN_HOME) and routed home B; gates in the process env only."""
