...
fallback. Does NOT exercise real fal_client submission.
"""
...
class TestGptQualityPinnedToMedium:
    ...
    and cannot be overridden via config. Pinning keeps FAL billing
...
class TestUpscaleDispatchForwarding:
    ...
    def test_dispatch_forwards_upscale(self, image_tool, monkeypatch):
        ...
        monkeypatch.setattr(
            "cryozen_cli.plugins._ensure_plugins_discovered", lambda *a, **k: None
        )
