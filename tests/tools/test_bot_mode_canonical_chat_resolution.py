...
apps/desktop/src/plugins/cryozen-bots/canonical-chat-registry.test.ts; here we pin the DB/RPC algebra
...
def home(tmp_path, monkeypatch):
    """Temp CRYOZEN_HOME so the gateway resolvers read a throwaway state.db.
