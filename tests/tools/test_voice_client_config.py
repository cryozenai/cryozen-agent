...
Real config files in a temp CRYOZEN_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated CRYOZEN_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "CRYOZEN_LOCAL_STT_LANGUAGE",
    ):
