...
from tools.mcp_oauth_provider import CryozenProviderMixin  # noqa: E402


class _Provider(CryozenProviderMixin, OAuthClientProvider):
    pass
...
def _provider_for(issuer: str, *, iss_in_redirect: str | None) -> _Provider:
    ...
    provider._cryozen_oauth_flow = "browser"
    return provider
