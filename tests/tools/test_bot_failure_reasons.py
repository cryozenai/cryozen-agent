...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `cryozen model` to select "
    "a provider, or run `cryozen setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for OpenAI Codex login."
