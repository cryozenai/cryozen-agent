...
* ``cryozen_constants.get_cryozen_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_cryozen_dir so cache writes land under tmp_path."""
    ...
    with patch("cryozen_constants.get_cryozen_dir", _fake_get):
        yield cache_dir
