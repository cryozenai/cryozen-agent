...
hardcoded "~/.cryozen-agent/scripts/" in its messages even though resolution goes
through get_cryozen_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_cryozen_home() is not the global ~/.cryozen-agent.
        scripts_dir = get_cryozen_home() / "scripts"
