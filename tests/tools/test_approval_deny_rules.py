...
def clean_env(monkeypatch):
    ...
    for var in ("CRYOZEN_YOLO_MODE", "CRYOZEN_GATEWAY_SESSION",
                "CRYOZEN_CRON_SESSION", "CRYOZEN_INTERACTIVE",
                "CRYOZEN_EXEC_ASK"):
...
class TestDenyOrdering:
    ...
    def test_container_backend_cannot_skip_deny(
        ...
        result = guard("chmod 600 /tmp/cryozen-approval-deny-test", env_type)
