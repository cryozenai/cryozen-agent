...
def make_cryozen_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated CRYOZEN_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"cryozen-home-{journal_mode}"
