"""Session <-> workspace grouping key (cryozen_state_sessions.workspace_key).

The key is what `cryozen sessions list --workspace` groups/filters on. It is a
...
import cryozen_state_sessions
from cryozen_state_sessions import workspace_key
