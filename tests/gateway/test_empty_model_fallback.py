...
class TestGetDefaultModelForProvider:
    """Unit tests for cryozen_cli.models.get_default_model_for_provider."""
    ...
    def test_catalog_label_overrides_constant(self):
        ...
        with patch(
            "cryozen_cli.model_catalog.get_default_model_from_cache",
            ...
            # the preferred default is trusted for OpenRouter, so the full resolver follows.
            assert (
