"""Tests for _setup_feishu() in cryozen_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("cryozen_cli.config.save_env_value", side_effect=mock_save), \
         patch("cryozen_cli.config.get_env_value", side_effect=mock_get), \
         patch("cryozen_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("cryozen_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("cryozen_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("cryozen_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("cryozen_cli.cli_output.print_header"), \
         patch("cryozen_cli.cli_output.print_info"), \
         patch("cryozen_cli.cli_output.print_success"), \
         patch("cryozen_cli.cli_output.print_warning"), \
         patch("cryozen_cli.cli_output.print_error"), \
