...
class RecordingAdapter:
    ...
    async def send(self, chat_id, content, metadata=None, **kw):
        self.calls.append(("send", str(get_cryozen_home())))
        return SimpleNamespace(success=True, error=None)

    async def send_private_notice(self, chat_id, user_id, content, metadata=None, **kw):
        self.calls.append(("send_private_notice", str(get_cryozen_home())))
        return SimpleNamespace(success=True, error=None)

    async def handle_message(self, event):
        self.calls.append(("handle_message", str(get_cryozen_home())))
