...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("CRYOZEN_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("CRYOZEN_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("CRYOZEN_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
