...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.cryozen-agent/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at cryozen_state import time, before pytest's CRYOZEN_HOME monkeypatch
    fires — the autouse fixture's CRYOZEN_HOME override doesn't help here.)
    """
