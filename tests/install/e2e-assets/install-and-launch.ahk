...
; Drive the REAL Cryozen-Setup.exe (Tauri bootstrap installer) window:
...
setupExe := A_Args.Length >= 2 ? A_Args[2] : "Cryozen-Setup.exe"
...
Log("Launch clicked; waiting for the Cryozen desktop app window")
...
try {
    ...
    throw Error("Cryozen.exe real-sized window did not appear within 300s of clicking Launch")
}
