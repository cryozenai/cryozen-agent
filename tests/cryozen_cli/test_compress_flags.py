...
Covers the pure helpers in ``cryozen_cli.partial_compress`` plus alias
...
from cryozen_cli.commands import COMMANDS, resolve_command
from cryozen_cli.partial_compress import (
    DEFAULT_KEEP_LAST,
