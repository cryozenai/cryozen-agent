...
class TestCurrentProviderCatalogWins:
    @pytest.mark.parametrize("provider,model", [
        ...
        ("deepseek", "some-live-only-model"),  # live catalog serves it, static snapshot doesn't
    ...
    def test_bare_name_resolves_to_current_providers_full_slug(self, live_catalog):
        live_catalog["ollama-cloud"] = ["zai/glm-5.3-flash"]
        assert models.detect_provider_for_model("glm-5.3-flash", "ollama-cloud") == ("ollama-cloud", "zai/glm-5.3-flash")
    ...
    def test_unserved_model_still_walks_the_ladder(self, live_catalog, monkeypatch):
        ...
        live_catalog["deepseek"] = ["deepseek-v4-pro"]
        assert models.detect_provider_for_model("no-such-model", "deepseek") == ("openrouter", "vendor/no-such-model")
