"""Tests for `_can_open_graphical_browser()` in cryozen_cli.auth.

Guards the fix for the May 2026 report where `cryozen auth add xai-oauth`
...
from cryozen_cli.auth import _can_open_graphical_browser
