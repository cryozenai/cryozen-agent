"""Tests for `cryozen chat --safe-mode` isolation."""
...
_VARS = ("CRYOZEN_SAFE_MODE", "CRYOZEN_IGNORE_USER_CONFIG", "CRYOZEN_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["CRYOZEN_SAFE_MODE"] == "1"
        assert os.environ["CRYOZEN_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["CRYOZEN_IGNORE_RULES"] == "1"
        return True
