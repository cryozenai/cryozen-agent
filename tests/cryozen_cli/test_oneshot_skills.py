...
The oneshot path builds its AIAgent directly (bypassing CryozenCLI), so the
...
from cryozen_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
