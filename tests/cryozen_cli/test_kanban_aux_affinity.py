...
from cryozen_cli import kanban_decompose as decompose
from cryozen_cli import kanban_specify as specify
...
def test_headless_kanban_aux_call_declares_a_stable_per_task_affinity_key(caller):
    from agent.conversation_context import get_affinity_scope
    seen: list = []
...
def test_in_turn_caller_keeps_its_declared_affinity_key():
    from agent.conversation_context import reset_affinity_scope, set_affinity_scope
    seen: list = []
...
def _dashboard_plugin_api():
    mod_name = "cryozen_dashboard_plugin_kanban_aux_affinity_test"
