...
from cryozen_cli.web_server_config import _UNSET, _apply_aux_assignment_sync


@pytest.fixture
def saved(monkeypatch):
    store: dict = {}
    monkeypatch.setattr("cryozen_cli.config.save_config", lambda cfg: store.update(cfg))
    return store
