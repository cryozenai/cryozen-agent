"""Tests for Blank Slate setup mode (cryozen_cli/setup.py).
...
from cryozen_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
