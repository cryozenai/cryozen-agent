"""Tests for ``cryozen approvals suggest`` (cryozen_cli/approvals_suggest.py).

Approval history in Cryozen is implied, not ledgered: the session DB
...
from cryozen_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
