...
The main() function in cryozen_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `cryozen -c model`
...
def _build_parser():
    """Build a minimal replica of the cryozen top-level parser."""
