"""Regression test: cryozen update must not load cryptography eagerly."""
...
assert 'cryozen_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running cryozen update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so cryozen_cli is importable,
