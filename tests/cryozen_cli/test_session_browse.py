"""Tests for the interactive session browser (`cryozen sessions browse`).
...
from cryozen_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """cryozen sessions browse should be parseable."""
