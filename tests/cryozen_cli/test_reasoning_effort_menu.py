from cryozen_cli.main_provider_setup import _prompt_reasoning_effort_selection
from cryozen_cli.setup import _current_reasoning_effort
...
def test_reasoning_menu_orders_minimal_before_low(monkeypatch):
    ...
    monkeypatch.setattr("cryozen_cli.curses_ui.curses_radiolist", _fake_radiolist)
