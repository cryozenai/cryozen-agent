"""Regression: ``cryozen update`` should take a managed checkout off autocrlf=true.
...
``cryozen update`` has to repair them.
...
from cryozen_cli.update_cmd import _normalize_managed_eol
