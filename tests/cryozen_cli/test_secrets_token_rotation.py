"""Tests for `cryozen secrets bitwarden token` / `cryozen secrets onepassword token`.
...
from cryozen_cli import onepassword_secrets_cli as op_cli
from cryozen_cli import secrets_cli as bw_cli
