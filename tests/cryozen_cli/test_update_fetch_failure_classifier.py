"""Fetch-failure classification for `cryozen update` / `cryozen update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/cryozenai/cryozen-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `cryozen update` sit on
    ...
    from cryozen_cli import update_cmd_git
