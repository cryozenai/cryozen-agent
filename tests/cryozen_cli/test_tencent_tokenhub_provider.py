...
# =============================================================================
# CANONICAL_PROVIDERS (cryozen model picker)
# =============================================================================
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        copy vendor/ form."""
        from cryozen_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from cryozen_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in CRYOZEN_OVERLAYS
        overlay = CRYOZEN_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from cryozen_cli.providers import CRYOZEN_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = CRYOZEN_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_alias_known(self, alias):
        from cryozen_cli.models import _KNOWN_PROVIDER_NAMES
