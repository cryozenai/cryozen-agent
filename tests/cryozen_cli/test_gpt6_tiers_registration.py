...
from cryozen_cli.model_switch import _model_sort_key
from cryozen_cli.models import OPENROUTER_MODELS
...
def test_gpt6_tiers_replace_56_in_aggregator_catalogs_with_pricing_aliases():
    for provider, listed in (("openrouter", {m for m, _ in OPENROUTER_MODELS}),):
