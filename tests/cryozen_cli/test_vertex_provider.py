...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (cryozen_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_cryozen_overlays():
    """cryozen_cli.providers.get_provider("vertex") backs
