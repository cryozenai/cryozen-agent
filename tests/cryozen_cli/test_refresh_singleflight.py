...
from cryozen_cli.dashboard_auth import refresh_singleflight as replay
from cryozen_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from cryozen_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"cryozen_session_at": "expired-at", "cryozen_session_rt": "stale-rt",
               "cryozen_session_provider": "stub"}
