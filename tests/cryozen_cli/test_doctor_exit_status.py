"""Regression for #117276: ``cryozen doctor``'s exit status must agree with its unresolved findings."""
...
def test_doctor_command_reports_remaining_findings(monkeypatch, capsys, issues, manual, fixed, fix, expected):
    ...
    from cryozen_cli.main import cmd_doctor
