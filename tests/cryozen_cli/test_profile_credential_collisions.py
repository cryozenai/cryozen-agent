...
local profile homes was invisible to ``cryozen doctor`` / ``cryozen gateway status``; the only signal
...
from cryozen_cli import doctor_state, gateway, gateway_migrate as gm
