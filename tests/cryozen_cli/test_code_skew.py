...
stale-module ImportError after ``cryozen update``.
"""
...
import cryozen_cli.web_routers.models as _rt_models
...
class TestModelSwitchSkewGuard:
    ...
    def test_guard_message_names_revs_and_restart(self, monkeypatch):
        ...
        assert "cryozen gateway restart" in msg
...
class TestModelOptionsSkewGuard:
    ...
    def test_fresh_dashboard_builds_payload_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr("cryozen_cli.inventory.load_picker_context", lambda: {})
