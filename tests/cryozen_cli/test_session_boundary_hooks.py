...
from cryozen_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/cryozen_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("cryozen_cli.lifecycle.invoke_hook")
@patch("cryozen_cli.lifecycle.finalize_session")
