"""Tests for the ``cryozen prompt-size`` diagnostic (issue #34667)."""
...
from cryozen_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(cryozen_home, memory_text="", user_text=""):
    mem_dir = cryozen_home / "memories"
...
def _seed_skill(cryozen_home, name, description):
    skill_dir = cryozen_home / "skills" / "demo" / name
