"""Tests for the shared byte formatter (cryozen_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from cryozen_cli.backup import _format_size as backup
    from cryozen_cli.checkpoints import _fmt_bytes as checkpoints
    from cryozen_cli.sizefmt import format_bytes as doctor
