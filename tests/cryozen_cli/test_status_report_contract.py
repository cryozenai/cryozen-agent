...
Every surface renders through ``cryozen_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("cryozen_constants.display_cryozen_home", return_value=HOME), \
