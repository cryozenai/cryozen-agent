...
import cryozen_cli.model_switch_providers as cryozen_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(cryozen_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("cryozen_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import cryozen_cli.models as hm
    import cryozen_cli.models_catalog_static as cryozen_cli_models_catalog_static
    from cryozen_cli import models_catalog_static
    ...
    monkeypatch.setattr(cryozen_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
