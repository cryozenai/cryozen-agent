...
from cryozen_cli.cron import _print_active_jobs_summary
...
def _frozen_clock(monkeypatch):
    ...
    monkeypatch.setattr(job_store, "_cryozen_now", lambda: now)
    monkeypatch.setattr("cryozen_time.now", lambda: now)
