...
class TestGetCopilotModelContext:
    ...
    @patch("cryozen_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("cryozen_cli.models._urlopen_model_catalog_request")
    ...
    @patch("cryozen_cli.models.fetch_github_model_catalog", return_value=[])
