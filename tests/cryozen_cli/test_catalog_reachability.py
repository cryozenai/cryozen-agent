...
Run before any catalog commit:
    ...
    CRYOZEN_TEST_NETWORK=1 scripts/run_tests.sh tests/cryozen_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("CRYOZEN_TEST_NETWORK"),
    reason="network test; set CRYOZEN_TEST_NETWORK=1 to run",
)
