"""Tests for cryozen_cli/setup_terminal.py backend wizards."""

import pytest

from cryozen_cli.config import save_env_value, get_env_value
from cryozen_cli import setup as setup_mod
from cryozen_cli import setup_terminal
