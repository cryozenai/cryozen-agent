...
def test_setup_offers_registered_provider_catalog(monkeypatch, live):
    ...
    from cryozen_cli import auth, config, model_setup_flows as flows, models
...
def test_setup_uses_profile_endpoint_and_headers(tmp_path, monkeypatch):
    ...
    import providers
    from providers.base import ProviderProfile
    from cryozen_cli import model_setup_flows as flows
...
def test_setup_matches_picker_when_catalog_fetch_fails(monkeypatch):
    ...
    import providers
    from providers.base import ProviderProfile
    from cryozen_cli import model_setup_flows as flows, models
...
def test_switch_validation_trusts_profile_owned_catalog(monkeypatch):
    ...
    import providers
    from providers.base import ProviderProfile
    from cryozen_cli import models, models_validate
