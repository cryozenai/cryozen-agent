...
A gateway ``/v1/models`` may answer each caller with the catalog their org can reach,
...
from cryozen_cli.models_pricing import fetch_models_with_pricing, peek_cached_pricing
