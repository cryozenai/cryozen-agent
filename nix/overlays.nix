# nix/overlays.nix — Expose pkgs.cryozen-agent for external NixOS configs
#
...
# `pkgs.cryozen-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    cryozen-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
