      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via CRYOZEN_BUNDLED_SKILLS /
            # CRYOZEN_OPTIONAL_SKILLS (see cryozen-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + CRYOZEN_BUNDLED_LOCALES
            # / CRYOZEN_OPTIONAL_MCPS, not via the wheel. Excluding them
        ...
        excludedFiles = [
          ...
          "flake.nix"
          "flake.lock"
          # Root docs the wheel doesn't consume.  README.md, LICENSE,
          # NOTICE and LICENSES/ must stay — pyproject.toml references
          # them (readme / license-files).
          "AGENTS.md"
          "CONTRIBUTING.md"
          "SECURITY.md"
          ".gitignore"
