...
from cryozen_state_common import _COMPRESSION_CHILD_SQL, escape_like as _escape_like
...
class SessionTitlesMixin:
    ...
    def resolve_session_by_title(self, title: str) -> Optional[str]:
        ...
        # it. Every DM transport (``cryozen -p <bot> chat --in ~ -c "Bot Chat"``: message_agent,
