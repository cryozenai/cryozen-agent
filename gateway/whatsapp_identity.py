...
plugins should use :func:`canonical_whatsapp_identifier` to line up with Cryozen' session keys.
"""
...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    if not normalized:
        return set()
    session_dir = get_cryozen_dir("platforms/whatsapp/session", "whatsapp/session")
