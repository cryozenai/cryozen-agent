...
the same three things: what Cryozen wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "Cryozen wants to run a command that needs your OK"
