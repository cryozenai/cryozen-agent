...
# `require_mention: true` without custom aliases uses Cryozen wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?cryozen\s+agent\b[,:\-]?", r"(?<![\w@])@?cryozen\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Cryozen defaults)."""
