...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Cryozen session"),
        ...
        _cmd("status", "Show Cryozen session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Cryozen agent"),
        ...
        _cmd("update", "Update Cryozen Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Cryozen gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Cryozen session in it",
