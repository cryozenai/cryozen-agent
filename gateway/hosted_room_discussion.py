...
# Openers of Cryozen' own control frames (agent.prompt_builder.CONTROL_FRAME_OPENERS: the steer marker, the
...
# Genuine user lines are never touched. Keep in sync with apps/desktop cryozen-bots/group-round-prompt.ts.
